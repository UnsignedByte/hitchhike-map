...
export async function init (
  ...
  schedule([
    'execute positioned 898.5 61 -61.5 if predicate hitchhike:onethird run function generated:misc/fountain',
    'execute positioned 892.5 61 -61.5 if predicate hitchhike:onethird run function generated:misc/fountain',
  ], 3, functions)
