    ...
    const items: Record<string, Record<string, any>> = {
      ...
      clothes: {
        pbblue: {
          ...
          tag: {
            cost: 2999,
            pos: ['986.74 64.5 -155.5', '986.74 64.5 -156.5', '986.74 64.5 -157.5', '986.74 64.5 -158.5'],
            rot: `'-90F,0F'`,
            display: {
              Name: `${rawJson({
        ...
        pbbrown: {
          ...
          tag: {
            cost: 2999,
            pos: ['986.75 65.5 -155.5', '986.75 65.5 -156.5', '986.75 65.5 -157.5', '986.75 65.5 -158.5'],
            rot: `'-90F,0F'`,
            display: {
              Name: `${rawJson({
        ...
        pbgray: {
          ...
          tag: {
            cost: 2999,
            pos: ['977.26 64.5 -163.0', '977.26 64.5 -163.8333', '977.26 64.5 -164.6666', '977.26 64.5 -165.5'],
            rot: `'90F,0F'`,
            display: {
              Name: `${rawJson({
