    ...
    const items: Record<string, Record<string, any>> = {
      ...
      clothes: {
        pbblue: {
          ...
          tag: {
            cost: 2999,
            pos: ['978.74 64.5 -163.0', '978.75 64.5 -163.8333', '978.75 64.5 -164.6666', '978.75 64.5 -165.5'],
            rot: `'-90F,0F'`,
            display: {
              Name: `${rawJson({
        ...
        pbgray: {
          ...
          tag: {
            cost: 2999,
            pos: ['977.26 64.5 -163.0', '977.25 64.5 -163.8333', '977.25 64.5 -164.6666', '977.25 64.5 -165.5'],
            rot: `'90F,0F'`,
            display: {
              Name: `${rawJson({
