...
give @a minecraft:copper_ingot{display: {Name: '{"text":"1b","color":"#bf5935"}', Lore: ['{"text":"Worth 0.10 BOV"}']}} 1
give @a minecraft:gold_ingot{display: {Name: '{"text":"1b","color":"#d99413"}', Lore: ['{"text":"Worth 0.25 BOV"}']}} 1
give @a minecraft:iron_ingot{display: {Name: '{"text":"1b","color":"#717171"}', Lore: ['{"text":"Worth 1.00 BOV"}']}} 1
give @a minecraft:netherite_ingot{display: {Name: '{"text":"1b","color":"#302829"}', Lore: ['{"text":"Worth 5.00 BOV"}']}} 1
