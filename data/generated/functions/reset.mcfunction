...
summon minecraft:villager 901.5 65 -152.5 {Rotation: [0f, 0f], Silent: 1b, Invulnerable: 1b, NoAI: 1b, NoGravity: 1b, CustomNameVisible: 1b, Tags: ["npc", "npc-apple_sale", "baby", "invisible"], CustomName: '{"text":"apple ($5)","color":"#ff0000","bold":true}', VillagerData: {type: "minecraft:plains", profession: "minecraft:none", level: 99}, Passengers: [{id: area_effect_cloud, CustomName: '{"text":"apple ($5)","color":"#ff0000","bold":true}', CustomNameVisible: 1, Duration: 2147483647}], Offers: {}}
scoreboard players set @e[tag=npc] dialogue-status 0
