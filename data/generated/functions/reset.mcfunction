...
give @a minecraft:nether_brick{display: {Name: '{"text":"1b","color":"#3d1e24"}', Lore: ['{"text":"Worth 0.01 BOV"}']}, Enchantments: [{}]} 1
give @a minecraft:brick{display: {Name: '{"text":"5b","color":"#7d3d2b"}', Lore: ['{"text":"Worth 0.05 BOV"}']}, Enchantments: [{}]} 1
give @a minecraft:copper_ingot{display: {Name: '{"text":"10b","color":"#bf5935"}', Lore: ['{"text":"Worth 0.10 BOV"}']}, Enchantments: [{}]} 1
give @a minecraft:gold_ingot{display: {Name: '{"text":"25b","color":"#d99413"}', Lore: ['{"text":"Worth 0.25 BOV"}']}, Enchantments: [{}]} 1
give @a minecraft:iron_ingot{display: {Name: '{"text":"1B","color":"#717171"}', Lore: ['{"text":"Worth 1.00 BOV"}']}, Enchantments: [{}]} 1
give @a minecraft:netherite_ingot{display: {Name: '{"text":"5B","color":"#302829"}', Lore: ['{"text":"Worth 5.00 BOV"}']}, Enchantments: [{}]} 1
