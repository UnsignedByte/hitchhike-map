...
# Give new quest book
give @a written_book{display: {Name: '{"text":"Quest Book","color":"light_purple","italic":true}'}, title: "Quest Book", author: "", pages: ['{"nbt":"quests[]","storage":"generated:quest_book","interpret":true}']}
