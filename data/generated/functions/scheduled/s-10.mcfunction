execute at @e[tag=checkpoint-marker] run particle minecraft:happy_villager ~ ~1.675 ~ 0.09 0.03 0.09 0 1
...
execute if score enabled maze matches 1 run function generated:story/maze/mobs/move
