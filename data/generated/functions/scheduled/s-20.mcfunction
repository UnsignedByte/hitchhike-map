...
execute if predicate hitchhike:batchchance as @r at @s at @e[tag=maze-node,distance=8..20,sort=random,limit=1] run function hitchhike:story/maze/mobs/summonbatch
