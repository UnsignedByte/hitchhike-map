...
execute as @e[type=villager,tag=npc,scores={dialogue-status=0..},tag=!speaking,tag=!invisible] at @s anchored eyes run particle minecraft:happy_villager ^ ^0.5 ^ 0 0 0 0 1 force
