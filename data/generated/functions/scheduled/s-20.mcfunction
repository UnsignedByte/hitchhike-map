...
execute if score enabled maze matches 1 if predicate hitchhike:batchchance as @r at @s run at @e[tag=maze-node,distance=4..16,sort=random,limit=1] function hitchhike:story/maze/mobs/summonbatch
