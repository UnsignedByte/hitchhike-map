...
execute at @e[tag=npc-bobknutz, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Bob Knutz","bold":true},"> ",{"text":"When did you get so big? Last time I saw you your dad could still pick you up with one arm!"}]
