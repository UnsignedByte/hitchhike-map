...
execute at @e[type=villager,tag=npc-bobknutz, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Bob Knots","color":"#b1bab7","bold":true},"> ",{"text":"When did you get so big? Last time I saw you your dad could still pick you up with one arm!"}]
...
schedule function generated:npc/bobknutz/0-3 112t
