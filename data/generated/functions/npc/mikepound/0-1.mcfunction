...
execute at @e[type=villager,tag=npc-mikepound, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Mike Pound","bold":true},"> ",{"text":"Not slow at all, if I do say so myself."}]
