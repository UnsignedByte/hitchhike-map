...
execute at @e[type=villager,tag=npc-mikepound, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Mike Pound","color":"#527536","bold":true},"> ",{"text":"What do you think about my K-d tree implementation?"}]
...
schedule function generated:npc/mikepound/0-1 64t
