...
execute at @e[tag=npc-jasminerocque, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jasmine Rocque","color":"#60437a","bold":true},"> ",{"text":"Don't tell me my dad signed up for the school's companion program like Percy..."}]
