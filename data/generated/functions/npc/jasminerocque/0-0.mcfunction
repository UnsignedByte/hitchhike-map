...
execute at @e[type=villager,tag=npc-jasminerocque, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jasmine Rocque","color":"#60437a","bold":true},"> ",{"text":"Hey, I don't know you! What are you doing here?"}]
...
schedule function generated:npc/jasminerocque/0-1 60t
