...
execute at @e[tag=npc-melon_slice, limit=1] run tellraw @a[distance=..50] ["<",{"text":"[\"melon_slice\",'{\"text\":\"(2.00B)\",\"bold\":false,\"italic\":false,\"strikethrough\":false,\"obfuscated\":false,\"underlined\":false}']","color":"null","bold":true},"> ",{"text":"taken"}]
