...
give @a[tag=victim-of-dialogue-by-carrot, limit=1] minecraft:paper{cost: 124, pos: '915.5 63.25 -162', display: {Name: '{"text":"Carrot","bold":false,"color":"#e6671e"}', Lore: ["{\"text\":\"Recommended by\",\"italic\":false,\"color\":\"#e36f17\"}","{\"text\":\"Pastor Ssempa\",\"italic\":false,\"color\":\"#e36f17\"}","{\"text\":\"\"}","{\"text\":\"Unsold (1.24B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, sold: 0b} 1
