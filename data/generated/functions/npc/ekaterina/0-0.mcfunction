...
execute at @e[type=villager,tag=npc-ekaterina, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ekaterina Zubov","color":"#9d86a6","bold":true},"> ",{"text":"Do you happen to know what has happened with the internet?"}]
