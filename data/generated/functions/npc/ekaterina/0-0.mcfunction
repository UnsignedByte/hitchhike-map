...
execute at @e[type=villager,tag=npc-ekaterina, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ekaterina Zubov","color":"#9d86a6","bold":true},"> ",{"text":"Oh, hello!"}]
...
schedule function generated:npc/ekaterina/0-1 12t
