...
execute at @e[type=villager,tag=npc-ekaterina, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ekaterina Zubov","bold":true},"> ",{"text":"Being offline makes it difficult to work."}]
