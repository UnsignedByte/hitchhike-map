...
execute at @e[type=villager,tag=npc-ekaterina, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ekaterina Zubov","color":"#9d86a6","bold":true},"> ",{"text":"Perhaps do you know what has happened with the internet?"}]
...
schedule function generated:npc/ekaterina/0-2 64t
