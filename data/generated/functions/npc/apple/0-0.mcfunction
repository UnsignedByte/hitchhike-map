...
execute at @e[tag=npc-apple, limit=1] run tellraw @a[distance=..50] ["<",["apple",{"text":" (2.00B)","bold":false,"italic":false,"strikethrough":false,"obfuscated":false,"underlined":false}],"> ",{"text":"taken"}]
