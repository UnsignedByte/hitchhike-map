...
execute at @e[tag=npc-glow_berries, limit=1] run tellraw @a[distance=..50] ["<",{"text":"'[\"\\\"glow_berries\\\"\",{\"text\":\"(2.00B)\",\"bold\":false,\"italic\":false,\"strikethrough\":false,\"obfuscated\":false,\"underlined\":false}]'","color":"null","bold":true},"> ",{"text":"taken"}]
