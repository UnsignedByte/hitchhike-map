...
execute at @e[tag=npc-ramen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Otori","color":"#8723a6","bold":true},"> ",{"interpret":true,"nbt":"ramenmenu","storage":"hitchhike:stores"}]
