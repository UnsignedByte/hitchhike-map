...
execute at @e[type=villager,tag=npc-ramen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Otori Okawa","color":"#8723a6","bold":true},"> ",{"interpret":true,"nbt":"welcome.ramen","storage":"hitchhike:stores"}]
