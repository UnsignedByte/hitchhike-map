...
execute at @e[tag=npc-ramen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Otori Okawa","color":"#8723a6","bold":true},"> ",{"text":"Welcome to YumeMasuku Ramen."}]
...
schedule function generated:npc/ramen/0-2 66t
