...
execute at @e[tag=npc-cameron, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Cameron \"Cam\" Au-Flauge","color":"#197037","bold":true},"> ",{"text":"I wonder if you'll accidentally stumble across anyone else."}]
...
schedule function generated:npc/cameron/0-9 114t
