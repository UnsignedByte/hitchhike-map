...
execute at @e[type=villager,tag=npc-cameron, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Cameron Au-Flauge","color":"#197037","bold":true},"> ",{"text":"If you were able to sneak up on me while I was using it, it clearly wasn't helping much, anyways."}]
...
schedule function generated:npc/cameron/0-8 116t
