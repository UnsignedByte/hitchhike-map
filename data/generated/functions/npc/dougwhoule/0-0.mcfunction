...
execute at @e[tag=npc-dougwhoule, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Douglas Hollerman","color":"#ebe34b","bold":true},"> ",{"text":"Nice hiding spot, isn't it?"}]
