...
execute at @e[tag=npc-ericrosman, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Erick Rosman","color":"#f5746e","bold":true},"> ",{"text":"Shush, I'm in the middle of a chess game."}]
