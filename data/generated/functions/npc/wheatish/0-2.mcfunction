...
execute at @e[tag=npc-wheatish, limit=1] run tellraw @a[distance=..25] ["<",{"text":"Mr. Wheat","color":"#c7a946","bold":true},"> ",{"text":"Anyways, you should get on with your daily whole wheat goodness!"}]
