...
execute at @e[tag=npc-wheatish, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Mr. Wheat","color":"#c7a946","bold":true},"> ",{"text":"I see you enjoyed the bread."}]
...
schedule function generated:npc/wheatish/2-1 66t
