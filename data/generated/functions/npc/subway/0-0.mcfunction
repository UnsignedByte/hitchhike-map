...
execute at @e[tag=npc-subway, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Silas Connelly","color":"#f0d792","bold":true},"> ",{"text":"Hey, welcome to Subway. How can I help you?"}]
