...
execute at @e[tag=npc-subway, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Silas Connelly","color":"#f0d792","bold":true},"> ",{"interpret":true,"nbt":"welcome.subway","storage":"hitchhike:stores"}]
