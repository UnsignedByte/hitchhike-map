...
give @a[tag=victim-of-dialogue-by-__safeway_beet, limit=1] minecraft:paper{cost: 149, display: {Name: '{"text":"Beet","bold":false,"color":"#7a1f3d"}', Lore: ["{\"text\":\"Beet red\",\"italic\":true,\"color\":\"#6c1b36\"}","{\"text\":\":flushed:\",\"italic\":true,\"color\":\"#6c1b36\"}","{\"text\":\"\"}","{\"text\":\"Unsold (1.49B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, store: "safeway", sold: 0b} 1
