...
execute at @e[tag=npc-janitor, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ivon Cummings","color":"#f2d811","bold":true},"> ",{"text":"A "},{"text":"win-win","italic":true},{"text":" situation, might it be called."}]
...
schedule function generated:npc/janitor/2-05 78t
