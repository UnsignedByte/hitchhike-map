...
execute at @e[tag=npc-janitor, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ivon Cummings","color":"#f2d811","bold":true},"> ",{"text":"It'll take care of some of my work, and you also get my "},{"text":"professional","italic":true},{"text":" tools to do the job."}]
