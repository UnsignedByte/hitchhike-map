...
execute at @e[tag=npc-janitor, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ivan Cummings","color":"#f2d811","bold":true},"> ",{"text":"It'll take care of some of my work, and you also get my "},{"text":"professional","italic":true},{"text":" tools to do the job."}]
...
schedule function generated:npc/janitor/2-10 162t
