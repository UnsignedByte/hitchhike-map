...
scoreboard players set @e[tag=npc-janitor, limit=1] quest-status 1
execute if score mouse quest-status matches -1.. run scoreboard players set @e[tag=npc-janitor, limit=1] quest-status 2
