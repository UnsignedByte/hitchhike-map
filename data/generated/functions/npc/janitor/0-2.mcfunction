...
execute at @e[type=villager,tag=npc-janitor, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ivan Cummings","color":"#f2d811","bold":true},"> ",{"text":"What am I doing? You brats made a huge mess all over the bio lab, and now I have to waste my time cleaning it up."}]
...
schedule function generated:npc/janitor/0-end 144t
