...
execute at @e[tag=npc-janitor, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ivon Cummings","color":"#f2d811","bold":true},"> ",{"text":"I, on the other hand, need this room cleaned, but do not want to clean it."}]
...
schedule function generated:npc/janitor/2-08 132t
