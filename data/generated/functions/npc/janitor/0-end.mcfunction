...
scoreboard players set @e[type=villager,tag=npc-janitor, limit=1] dialogue-status 1
execute if score mouse quest-status matches -1.. run scoreboard players set @e[type=villager,tag=npc-janitor, limit=1] dialogue-status 2
