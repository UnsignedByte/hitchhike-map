...
execute at @e[type=villager,tag=npc-janitor, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ivan Cummings","color":"#f2d811","bold":true},"> ",{"text":"What do you want, my lunch money? The bio lab is currently off limits, can't you read?"}]
...
schedule function generated:npc/janitor/1-1 92t
