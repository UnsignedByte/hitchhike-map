...
execute at @e[tag=npc-janitor, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ivon Cummings","color":"#f2d811","bold":true},"> ",{"text":"Why do you keep bothering me? The bio lab is currently off limits, can't you read?"}]
...
schedule function generated:npc/janitor/1-1 144t
