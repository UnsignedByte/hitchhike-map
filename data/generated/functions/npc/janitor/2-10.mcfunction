...
execute at @e[tag=npc-janitor, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ivan Cummings","color":"#f2d811","bold":true},"> ",{"text":"Sounds like a great deal, doesn't it?"}]
...
schedule function generated:npc/janitor/2-11 72t
