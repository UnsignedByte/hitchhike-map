...
execute at @e[type=villager,tag=npc-janitor, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ivan Cummings","color":"#f2d811","bold":true},"> ",{"text":"So, why don't I just give you my tools, and you can clean this room yourself to look for that backpack."}]
...
schedule function generated:npc/janitor/2-09 174t
