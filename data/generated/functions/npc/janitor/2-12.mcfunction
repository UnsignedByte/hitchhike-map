...
execute at @e[type=villager,tag=npc-janitor, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ivan Cummings","color":"#f2d811","bold":true},"> ",{"text":"Don't worry, I'll continue standing right outside to make sure any passersby will think I'm still working hard."}]
...
schedule function generated:npc/janitor/2-end 116t
