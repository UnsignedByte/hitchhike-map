...
execute at @e[type=villager,tag=npc-hurm, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Herb Schmitt","color":"#183aab","bold":true},"> ",{"text":"Well, sport, the only way to the trails is through the huge lake right here, and the only way through the lake is on "},{"text":"my","italic":true},{"text":" precious boat."}]
...
schedule function generated:npc/hurm/0-07 222t
