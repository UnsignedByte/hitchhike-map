...
execute at @e[type=villager,tag=npc-hurm, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Herb Schmitt","color":"#3f7bd5","bold":true},"> ",{"text":"Feel free to take the boat out on the dock for a spin, you've earned it! But please try not to sink it."}]
...
schedule function generated:npc/hurm/2-8 132t
