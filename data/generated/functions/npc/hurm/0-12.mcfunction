...
execute at @e[type=villager,tag=npc-hurm, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Herb Schmitt","color":"#183aab","bold":true},"> ",{"text":"You can find an old firepit I've used just outside to the east."}]
...
schedule function generated:npc/hurm/0-13 88t
