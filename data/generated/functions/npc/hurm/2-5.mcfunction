...
execute at @e[type=villager,tag=npc-hurm, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Herb Schmitt","color":"#3f7bd5","bold":true},"> ",{"text":"Or was it Sullivan? Salmon? Salmon. That must be it. Speaking of which, this fish is incredible!"}]
...
schedule function generated:npc/hurm/2-6 104t
