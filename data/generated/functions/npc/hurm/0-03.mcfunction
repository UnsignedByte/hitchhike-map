...
execute at @e[type=villager,tag=npc-hurm, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Herb Schmitt","color":"#3f7bd5","bold":true},"> ",{"text":"Yer telling me ya wanna get up the mountain?"}]
...
schedule function generated:npc/hurm/0-04 56t
