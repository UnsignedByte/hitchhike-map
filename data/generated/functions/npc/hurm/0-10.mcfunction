...
execute at @e[type=villager,tag=npc-hurm, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Herb Schmitt","color":"#3f7bd5","bold":true},"> ",{"text":"I was in the mood for a late-night snack anyways.","italic":true}]
...
schedule function generated:npc/hurm/0-11 56t
