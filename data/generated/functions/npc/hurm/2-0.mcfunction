...
execute at @e[type=villager,tag=npc-hurm, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Herb Schmitt","color":"#183aab","bold":true},"> ",{"text":"Yer back, sport! With the fish!"}]
...
execute at @e[type=villager,tag=npc-hurm, limit=1] run function hitchhike:story/hurm/clear_one_fish
execute at @e[type=villager,tag=npc-hurm, limit=1] run function hitchhike:story/hurm/clear_one_fish
execute at @e[type=villager,tag=npc-hurm, limit=1] run function hitchhike:story/hurm/clear_one_fish
execute at @e[type=villager,tag=npc-hurm, limit=1] run function hitchhike:story/hurm/clear_one_fish
