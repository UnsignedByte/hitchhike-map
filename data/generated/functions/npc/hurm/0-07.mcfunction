...
execute at @e[type=villager,tag=npc-hurm, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Herb Schmitt","color":"#3f7bd5","bold":true},"> ",{"text":"And I won't let random kids who have no idea what they're doing through my fishing ground."}]
...
schedule function generated:npc/hurm/0-08 100t
