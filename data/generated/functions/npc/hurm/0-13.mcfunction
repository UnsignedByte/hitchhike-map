...
execute at @e[type=villager,tag=npc-hurm, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Herb Schmitt","color":"#183aab","bold":true},"> ",{"text":"I'll even let you use my fishing rods. They're in the garage, if remember correctly."}]
...
schedule function generated:npc/hurm/0-14 144t
