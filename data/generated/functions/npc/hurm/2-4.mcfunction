...
execute at @e[type=villager,tag=npc-hurm, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Herb Schmitt","color":"#183aab","bold":true},"> ",{"text":"... Sorry for talking while eating, I don't usually see anyone other than Solomon. Sometimes you'd think he's still a youngster with how chipper he is."}]
...
schedule function generated:npc/hurm/2-5 264t
