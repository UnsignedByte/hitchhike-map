...
execute at @e[type=villager,tag=npc-hurm, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Herb Schmitt","color":"#183aab","bold":true},"> ",{"text":"I've been reading a lot about crustaceans recently."}]
...
schedule function generated:npc/hurm/2-3 108t
