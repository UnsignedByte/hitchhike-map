...
execute at @e[tag=npc-samsung, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Samantha Sung","color":"#945da1","bold":true},"> ",{"text":"It's so dark I can't even distinguish it from reality."}]
