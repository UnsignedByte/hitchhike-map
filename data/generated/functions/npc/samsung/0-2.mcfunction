...
execute at @e[tag=npc-samsung, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Samantha Sung","bold":true},"> ",{"text":"It's so dark I couldn't even distinguish it from reality."}]
