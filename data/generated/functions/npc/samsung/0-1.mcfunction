...
execute at @e[tag=npc-samsung, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Samantha Sung","color":"#945da1","bold":true},"> ",{"text":"Don't mind me, I was just admiring the "},{"text":"Deep Blacks™","bold":true,"italic":true},{"text":" feature of my 230\" Class 8k QLED Samsung Smart TV."}]
