...
execute at @e[tag=npc-stephen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Stephen Fallus","bold":true},"> ",{"text":"Additionally, I would also implore us to consider the large-scale impacts of such changes within the environment of the company."}]
...
schedule function generated:npc/stephen/1-end 240t
