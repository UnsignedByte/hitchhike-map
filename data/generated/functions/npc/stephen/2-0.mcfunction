...
execute at @e[type=villager,tag=npc-stephen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Steve Allen","color":"#f08c71","bold":true},"> ",{"text":"Did he even listen to us?"}]
...
schedule function generated:npc/stephen/2-1 32t
