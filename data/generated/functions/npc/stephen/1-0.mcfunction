...
execute at @e[type=villager,tag=npc-stephen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Stephen Fallus","color":"#f08c71","bold":true},"> ",{"text":"I definitely agree with Matthew on this."}]
...
schedule function generated:npc/stephen/1-1 78t
