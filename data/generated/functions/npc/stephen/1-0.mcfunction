...
execute at @e[tag=npc-stephen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Stephen Fallus","bold":true},"> ",{"text":"Indeed, I definitely agree with these ideas."}]
...
schedule function generated:npc/stephen/1-1 102t
