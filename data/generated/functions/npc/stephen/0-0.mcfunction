...
execute at @e[type=villager,tag=npc-stephen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Steve Allen","color":"#f08c71","bold":true},"> ",{"text":"Hmm... You make a very interesting proposition."}]
