...
execute at @e[type=villager,tag=npc-stephen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Steve Allen","color":"#f08c71","bold":true},"> ",{"text":"A shift toward such an innovative paradigm must be a profitable move for this company."}]
...
schedule function generated:npc/stephen/0-end 108t
