...
execute at @e[tag=npc-duarteeisenhower, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Art Eisenhower","color":"#edc085","bold":true},"> ",{"text":"You're "},{"text":"still","italic":true},{"text":" awake? Just go to sleep, grandpa!"}]
