...
execute at @e[tag=npc-duarteeisenhower, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Duarte Eisenhower","bold":true},"> ",{"text":"Weren't you tired just a couple minutes ago?"}]
