...
execute at @e[type=villager,tag=npc-douglassainsworth, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Douglass Ainsworth","color":"#9817d4","bold":true},"> ",{"text":"Wait, What's a kid like you doing here? You better not be another one of Percy's \"friends.\""}]
...
schedule function generated:npc/douglassainsworth/0-4 168t
