...
execute at @e[type=villager,tag=npc-douglassainsworth, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Douglass Ainsworth","color":"#9817d4","bold":true},"> ",{"text":"He's still in a meeting with Damien, and might be busy for a while."}]
