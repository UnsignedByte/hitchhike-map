...
execute as @e[type=villager,tag=npc-__safeway_mysteryshrooms, limit=1] at @s run tp @s ~ ~ ~ 0 0
tag @e[type=villager,tag=npc-__safeway_mysteryshrooms, limit=1] remove speaking
