...
give @a[tag=victim-of-dialogue-by-apple_sale, limit=1] minecraft:glow_berries{cost: 200, display: {Lore: ["{\"text\":\"Unsold (2.00B)\",\"italic\":true,\"color\":\"dark_gray\"}","{\"text\":\"Sold (2.00B)\",\"italic\":true,\"color\":\"dark_purple\"}"]}, sold: 0b} 1
