...
execute at @e[tag=npc-melon_sale, limit=1] run tellraw @a[distance=..50] ["<",{"text":"Watermelon (${toCost(item.store.unsold.melon.tag.cost)})","color":"#ff5733","bold":true},"> ",{"text":"taken"}]
