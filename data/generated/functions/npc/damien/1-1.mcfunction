...
execute at @e[type=villager,tag=npc-damien, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Damien Herst","bold":true},"> ",{"text":"Erm, that was a great discussion, I'm sure we could look further into some of the ideas proposed."}]
