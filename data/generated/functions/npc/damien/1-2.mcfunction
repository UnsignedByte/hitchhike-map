...
execute at @e[tag=npc-damien, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Damien Herst","bold":true},"> ",{"text":"Why don't both of you do some more research and get back to me with your findings?"}]
