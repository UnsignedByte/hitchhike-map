...
execute at @e[tag=npc-__safeway_monster, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",[{"text":"Monster Energy","color":"green"},{"text":" (7.99B)","bold":false,"italic":false,"strikethrough":false,"obfuscated":false,"underlined":false}],"> ",{"text":"taken"}]
