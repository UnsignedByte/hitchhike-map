...
give @a[tag=victim-of-dialogue-by-__safeway_kelp, limit=1] minecraft:paper{cost: 119, display: {Name: '{"text":"Seaweed","bold":false,"color":"#3bbd17"}', Lore: ["{\"text\":\"Fresh and Undried\",\"italic\":true,\"color\":\"#2fa315\"}","{\"text\":\"\"}","{\"text\":\"Unsold (1.19B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, store: "safeway", item: "kelp", sold: 0b} 1
