...
execute at @e[tag=npc-poolgoer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Bucky Cradle","color":"#9c231a","bold":true},"> ",{"text":"... Yeah, so I'm also part of that whole \"Hide and Seek\" thing, y'know?"}]
