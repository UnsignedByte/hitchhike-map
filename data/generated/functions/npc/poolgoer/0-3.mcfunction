...
execute at @e[type=villager,tag=npc-poolgoer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Bucky Cradle","color":"#9c231a","bold":true},"> ",{"text":"And nobody's really found me much yet, so I think I chose pretty well."}]
...
schedule function generated:npc/poolgoer/0-4 72t
