...
execute at @e[type=villager,tag=npc-__safeway_honeycomb, limit=1] run tag @a[distance=..25] add npc-eavesdropper
# Dialogue line #0-1: speak and make noise.

# silent // execute at @e[type=villager,tag=npc-__safeway_honeycomb, limit=1] run playsound minecraft:entity.villager.ambient player @a[tag=npc-eavesdropper] ~ ~ ~ 1000 1 1
...
schedule function generated:npc/__safeway_honeycomb/0-end 8t
