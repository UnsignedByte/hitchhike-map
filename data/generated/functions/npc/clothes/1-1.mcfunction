...
execute at @e[type=villager,tag=npc-clothes, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jean Slimm","color":"#2387d9","bold":true},"> ",{"interpret":true,"nbt":"success.clothes","storage":"hitchhike:stores"}]
