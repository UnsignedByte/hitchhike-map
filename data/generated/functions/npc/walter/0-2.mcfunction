...
execute at @e[tag=npc-walter, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Walter Wheat","color":"#f7e5dc","bold":true},"> ",{"text":"There is absolutely nothing unusual being cooked here."}]
