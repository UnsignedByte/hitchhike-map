...
execute at @e[type=villager,tag=npc-walter, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Walter Wheat","color":"#f7e5dc","bold":true},"> ",{"text":"What are you doing in my trailer??"}]
...
schedule function generated:npc/walter/0-1 44t
