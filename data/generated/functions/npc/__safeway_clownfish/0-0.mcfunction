...
give @a[tag=victim-of-dialogue-by-__safeway_clownfish, limit=1] minecraft:paper{cost: 1299, pos: '902.5 64 -166.3', display: {Name: '{"text":"Clownfish","bold":false,"color":"#ed8c37"}', Lore: ["{\"text\":\"Here Lies\",\"italic\":false,\"color\":\"#ffc59e\"}","{\"text\":\"Nemo (2003-2003)\",\"italic\":false,\"color\":\"#ffc59e\"}","{\"text\":\"Rest in Peace.\",\"italic\":false,\"color\":\"#ffc59e\"}","{\"text\":\"\"}","{\"text\":\"Unsold (12.99B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, store: "safeway", sold: 0b} 1
