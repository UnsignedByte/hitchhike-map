...
execute at @e[tag=npc-__safeway_clownfish, limit=1] run tag @a[distance=..25] add npc-eavesdropper
...
schedule function generated:npc/__safeway_clownfish/0-end 24t
