...
execute at @e[tag=npc-fountainman, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Sylvian Bismarck","color":"#9c389c","bold":true},"> ",{"text":"Hello there, hope your day is going well..."}]
...
schedule function generated:npc/fountainman/2-end 78t
