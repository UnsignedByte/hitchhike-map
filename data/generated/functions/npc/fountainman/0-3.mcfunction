...
execute at @e[tag=npc-fountainman, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Sylvian Bismarck","color":"#9c389c","bold":true},"> ",{"text":"Fret not, for "},{"text":"I've","italic":true},{"text":" got the perfect opportunity for you."}]
...
schedule function generated:npc/fountainman/0-4 96t
