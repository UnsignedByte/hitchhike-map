...
execute at @e[tag=npc-fountainman, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Sylvian Bismarck","color":"#9c389c","bold":true},"> ",{"text":"Get some hopes and dreams for yourself, too.","italic":true}]
...
schedule function generated:npc/fountainman/0-end 84t
