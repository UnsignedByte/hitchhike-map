...
execute at @e[type=villager,tag=npc-fountainman, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Sylvian Bismarck","color":"#9c389c","bold":true},"> ",{"text":"No","italic":true},{"text":"? Well that's exactly it, isn't it? Where have they been going?"}]
...
schedule function generated:npc/fountainman/0-06 68t
