...
give @a[tag=victim-of-dialogue-by-__safeway_rawmutton, limit=1] minecraft:paper{cost: 699, pos: '915.5 64.5 -165.25', display: {Name: '{"text":"Mutton","bold":false,"color":"#a30b2c"}', Lore: ["{\"text\":\"Wool not included.\",\"italic\":true,\"color\":\"blue\"}","{\"text\":\"\"}","{\"text\":\"Unsold (6.99B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, store: "safeway", sold: 0b} 1
