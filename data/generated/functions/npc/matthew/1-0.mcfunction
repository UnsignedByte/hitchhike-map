...
execute at @e[tag=npc-matthew, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Matthew Sciento","bold":true},"> ",{"text":"Uhh... so what now?"}]
...
tp @e[tag=npc-matthew, limit=1] 796.50 78 -48.30 45 0
