...
execute at @e[type=villager,tag=npc-matthew, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Matthew Sciento","color":"#5c3f16","bold":true},"> ",{"text":"Uhh... so what now?"}]
