...
execute at @e[type=villager,tag=npc-matthew, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Matthew Cinto","color":"#5c3f16","bold":true},"> ",{"text":"Uhh... so what now?"}]
...
schedule function generated:npc/matthew/1-end 16t
