...
execute at @e[tag=npc-matthew, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Matthew Sciento","bold":true},"> ",{"text":"The adoption of these new approaches toward marketing and design can definitely lead to an unequivocally positive effect on earnings."}]
