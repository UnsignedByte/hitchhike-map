...
execute at @e[type=villager,tag=npc-matthew, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Matthew Sciento","color":"#5c3f16","bold":true},"> ",{"text":"All we need is your \"okay\" and we can go get the funding to implement some of these ideas."}]
...
schedule function generated:npc/matthew/0-end 174t
