...
execute at @e[type=villager,tag=npc-nortonhill, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Norton Hill","color":"#ddf013","bold":true},"> ",{"text":"Great decision, Dr. Ffosse!"}]
...
schedule function generated:npc/nortonhill/0-end 48t
