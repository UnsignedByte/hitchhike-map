...
execute at @e[type=villager,tag=npc-nortonhill, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Norton Hill","color":"#ddf013","bold":true},"> ",{"text":"I am appalled these \"unioners\" would ask for even more; our employess already enjoy numerous benefits."}]
...
schedule function generated:npc/nortonhill/0-2 216t
