...
execute at @e[type=villager,tag=npc-starbucks, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Bethany Norma","color":"#00704a","bold":true},"> ",{"interpret":true,"nbt":"success.starbucks","storage":"hitchhike:stores"}]
...
schedule function generated:npc/starbucks/1-end 24t
