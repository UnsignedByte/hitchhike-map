...
execute at @e[tag=npc-starbucks, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Bethany Norma","color":"#00704a","bold":true},"> ",{"interpret":true,"nbt":"success.starbucks","storage":"hitchhike:stores"}]
