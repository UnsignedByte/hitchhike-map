...
execute at @e[type=villager,tag=npc-safeway, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Harold Pell","color":"#ed81b8","bold":true},"> ",{"text":"Good morning! I'm Harry from Safeway, welcome!"}]
...
schedule function generated:npc/safeway/0-1 52t
