...
execute at @e[type=villager,tag=npc-safeway, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Harold Pell","color":"#ed81b8","bold":true},"> ",{"interpret":true,"nbt":"welcome.safeway","storage":"hitchhike:stores"}]
