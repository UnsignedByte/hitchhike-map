...
execute at @e[tag=npc-safeway, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Paoule Enrique","color":"#eb7060","bold":true},"> ",{"interpret":true,"nbt":"success.safeway","storage":"hitchhike:stores"}]
