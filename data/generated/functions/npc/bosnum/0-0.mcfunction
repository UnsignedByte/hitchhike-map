...
execute at @e[tag=npc-bosnum, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Bobby Bert","color":"#dedede","bold":true},"> ",{"text":"Oh, hi. Did I leave the door unlocked?"}]
