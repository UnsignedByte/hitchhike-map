...
execute at @e[tag=npc-giffy, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Johnny Elton","color":"#86943a","bold":true},"> ",{"text":"Anybody who searches in here must be real sicko to go into a children's bathroom."}]
