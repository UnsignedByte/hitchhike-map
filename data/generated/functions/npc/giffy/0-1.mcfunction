...
execute at @e[tag=npc-giffy, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Giffy Hapsteen","color":"#86943a","bold":true},"> ",{"text":"No one will ever expect that I, a fully-grown adult man, is hiding in the high-school student restroom!"}]
