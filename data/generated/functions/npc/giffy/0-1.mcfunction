...
execute at @e[type=villager,tag=npc-giffy, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Johnny Elton","color":"#86943a","bold":true},"> ",{"text":"No one will ever expect that I, a fully-grown adult man, is hiding in the high-school student restroom!"}]
...
schedule function generated:npc/giffy/0-2 116t
