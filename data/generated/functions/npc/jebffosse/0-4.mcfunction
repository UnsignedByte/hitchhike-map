...
execute at @e[type=villager,tag=npc-jebffosse, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jeb Ffosse","color":"#cf1613","bold":true},"> ",{"text":"I don't think any of our workers need any of the proposed changes; adding \"bathroom breaks\" and \"paid time off\" will only lower productivity and profitability."}]
...
schedule function generated:npc/jebffosse/0-5 276t
