...
execute at @e[type=villager,tag=npc-jebffosse, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jedd Fosse","color":"#cf1613","bold":true},"> ",{"text":"What are you doing in my office? Get out!"}]
...
schedule function generated:npc/jebffosse/0-1 56t
