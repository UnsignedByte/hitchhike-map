...
execute at @e[type=villager,tag=npc-jebffosse, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jedd Fosse","color":"#cf1613","bold":true},"> ",{"text":"Why are you still standing abound? Itching to get fired?"}]
...
schedule function generated:npc/jebffosse/0-2 64t
