...
execute at @e[type=villager,tag=npc-jebffosse, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jedd Fosse","color":"#cf1613","bold":true},"> ",{"text":"...Anyways, what was I saying..."}]
...
tag @e[type=villager,tag=npc-jebffosse, limit=1] add npc-unface
tp @e[type=villager,tag=npc-jebffosse, limit=1] 797.50 84 -78.30 -25 0
schedule function generated:npc/jebffosse/0-3 28t
