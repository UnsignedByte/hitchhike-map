...
execute at @e[type=villager,tag=npc-levirosman, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Levi Rosman","color":"#f0534d","bold":true},"> ",{"text":"... Ugh, did he just play Ra4???"}]
...
schedule function generated:npc/levirosman/0-end 24t
