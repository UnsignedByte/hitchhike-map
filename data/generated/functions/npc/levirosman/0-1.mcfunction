...
execute at @e[tag=npc-levirosman, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Levi Rosman","bold":true},"> ",{"text":"Can't you see I'm engaged in an intense game of boardless chess?"}]
