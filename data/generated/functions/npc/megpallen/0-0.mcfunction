...
execute at @e[type=villager,tag=npc-megpallen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Maggie Pallen","color":"#8ad7eb","bold":true},"> ",{"text":"Hi, did you see Maggie outside?"}]
...
schedule function generated:npc/megpallen/0-1 52t
