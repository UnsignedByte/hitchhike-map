...
execute at @e[tag=npc-megpallen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Maggie Pallen","color":"#8ad7eb","bold":true},"> ",{"text":"Maggie is trying out a vegan diet for the first time."}]
