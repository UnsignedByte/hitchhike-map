...
execute at @e[tag=npc-megpallen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Maggie Pallen","bold":true},"> ",{"text":"Maggie is trying out a vegan diet."}]
...
schedule function generated:npc/megpallen/0-2 72t
