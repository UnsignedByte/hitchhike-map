...
execute at @e[type=villager,tag=npc-megpallen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Maggie Pallen","color":"#8ad7eb","bold":true},"> ",{"text":"Bark is very nutritious."}]
...
schedule function generated:npc/megpallen/0-end 32t
