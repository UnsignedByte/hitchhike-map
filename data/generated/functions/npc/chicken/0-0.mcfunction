...
give @a[tag=victim-of-dialogue-by-chicken, limit=1] minecraft:paper{cost: 699, pos: '914.25 64.5 -166.5', display: {Name: '{"text":"Chicken","bold":false,"color":"#e3aa81"}', Lore: ["{\"text\":\"Kentucky Unfried\",\"italic\":true,\"color\":\"blue\"}","{\"text\":\"\"}","{\"text\":\"Unsold (6.99B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, sold: 0b} 1
