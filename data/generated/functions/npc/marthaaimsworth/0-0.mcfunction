...
execute at @e[tag=npc-marthaaimsworth, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Martha Aimsworth","color":"#91faf2","bold":true},"> ",{"text":"Oh, hi! Sorry, I must've spaced out."}]
