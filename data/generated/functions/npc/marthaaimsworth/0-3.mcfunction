...
execute at @e[tag=npc-marthaaimsworth, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Martha Aimsworth","color":"#91faf2","bold":true},"> ",{"text":"Well, anyways, you kiddos have fun playing, and don't hesitate to ask me if you need anything."}]
...
schedule function generated:npc/marthaaimsworth/0-4 168t
