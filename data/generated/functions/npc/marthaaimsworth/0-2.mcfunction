...
execute at @e[tag=npc-marthaaimsworth, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Martha Aimsworth","color":"#91faf2","bold":true},"> ",{"text":"I'm so glad he seems to have so many friends now! It's almost a different friend every day."}]
...
schedule function generated:npc/marthaaimsworth/0-3 156t
