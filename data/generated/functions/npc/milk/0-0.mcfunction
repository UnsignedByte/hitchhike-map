...
give @a[tag=victim-of-dialogue-by-milk, limit=1] minecraft:paper{cost: 599, pos: '914 62.75 -152.5', display: {Name: '{"text":"Whole Milk","bold":true,"color":"#f5f3e6"}', Lore: ["{\"text\":\"Got Milk?\",\"italic\":false,\"color\":\"aqua\"}","{\"text\":\"Homogenized\",\"italic\":true,\"color\":\"gray\"}","{\"text\":\"\"}","{\"text\":\"Unsold (5.99B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, sold: 0b} 1
