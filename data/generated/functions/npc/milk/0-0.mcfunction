...
give @a[tag=victim-of-dialogue-by-milk, limit=1] minecraft:paper{cost: 599, pos: '914.5 62.5 -152.9', display: {Name: '{"text":"Whole Milk","bold":true,"color":"#f5f3e6"}', Lore: ["{\"text\":\"Got Milk?\",\"italic\":false,\"color\":\"aqua\"}","{\"text\":\"\"}","{\"text\":\"Unsold (5.99B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, sold: 0b} 1
