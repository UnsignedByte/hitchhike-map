...
execute at @e[tag=npc-clothescashier, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jean Skinne","color":"#2387d9","bold":true},"> ",{"text":"Feel free to try on clothes in the changing rooms to your right!"}]
...
schedule function generated:npc/clothescashier/0-end 108t
