...
execute at @e[type=villager,tag=npc-plenton, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Mrs. Plenton","color":"#96a2ab","bold":true},"> ",{"text":"Good heavens, your parents should have taught you some manners."}]
...
schedule function generated:npc/plenton/0-4 84t
