...
execute at @e[tag=npc-plenton, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Mrs. Plenton","color":"#96a2ab","bold":true},"> ",{"text":"No need to gawk at me, as you can see I don't have any other places with this much water, do I?"}]
