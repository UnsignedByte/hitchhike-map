...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Last thing... If you come across anyone on the way, try not to bother them, for both of your sakes."}]
...
schedule function generated:npc/simon/7-14 108t
