...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Ugh, whatever. I have nothing more to say to you."}]
...
schedule function generated:npc/simon/1-end 64t
