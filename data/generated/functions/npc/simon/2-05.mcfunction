...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"And it seems like you did listen to my directions and diligently prepared as I had requested."}]
...
schedule function generated:npc/simon/2-06 120t
