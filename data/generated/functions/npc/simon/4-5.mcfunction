...
# Dialogue line #4-6: speak and make noise.
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"So, I see you brought back my LaCroix! Admirable."}]
...
schedule function generated:npc/simon/4-6 96t
