...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Trust me, I've seen what's up there many times on my... Errands. And it's not pretty."}]
...
schedule function generated:npc/simon/0-6 120t
