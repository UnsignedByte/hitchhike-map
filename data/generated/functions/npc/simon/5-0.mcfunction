...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Hello again, my friend! I see you're as interested in Morton as I am!"}]
...
schedule function generated:npc/simon/5-1 144t
