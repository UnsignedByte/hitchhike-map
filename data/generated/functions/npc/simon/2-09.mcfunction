...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"This is an old SD card that contains a map of the hiking trail up the mountain back from when I first started my errands."}]
...
schedule function generated:npc/simon/2-10 128t
