...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"How many times do I need to say it before it gets through your thick skull?"}]
...
schedule function generated:npc/simon/1-2 132t
