...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#6bdfc3","bold":true},"> ",{"text":"Sorry, I was distracted again; I was admiring my one-of-a-kind "},{"text":"Sedimentary Cryptocrystalline Quartz (Chert)","color":"#9ba5a8"},{"text":" stone."}]
