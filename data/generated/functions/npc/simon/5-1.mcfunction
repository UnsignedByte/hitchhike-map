...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Oh, Morton is the name of the rock, in case you couldn't tell."}]
...
schedule function generated:npc/simon/5-2 108t
