...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"You think you can just walk through MY property, dirty MY driveway, waste MY time, and give me NOTHING in return?"}]
...
schedule function generated:npc/simon/2-19 116t
