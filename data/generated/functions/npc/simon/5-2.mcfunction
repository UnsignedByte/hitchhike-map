...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#6bdfc3","bold":true},"> ",{"text":"Anyways, glad to see another connoisseur of mineral collection; it's hard to find people interested in such a high-class hobby nowadays."}]
...
schedule function generated:npc/simon/5-3 168t
