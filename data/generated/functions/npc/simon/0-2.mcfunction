...
execute at @e[tag=npc-simon, limit=1] run tellraw @a[distance=..50] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Get off my land! I'll call the police on you, I WILL."}]
...
schedule function generated:npc/simon/0-3 -1t
