...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Get off my land, plebeian! I'll call the police on you if I have to."}]
...
schedule function generated:npc/simon/0-3 126t
