...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#6bdfc3","bold":true},"> ",{"text":"I'll have you know that you... "},{"text":"People","italic":true},{"text":" are NOT welcome up here. This is private property, and trespassing is "},{"text":"ILLEGAL","bold":true},{"text":"."}]
...
schedule function generated:npc/simon/0-2 144t
