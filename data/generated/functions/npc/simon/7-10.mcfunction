...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#6bdfc3","bold":true},"> ",{"text":"Anyways, I suppose you'll want to be going now."}]
...
schedule function generated:npc/simon/7-11 56t
