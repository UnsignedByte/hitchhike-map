...
execute at @e[tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Not bad! At least you can listen to directions. Most people don't do that very well."}]
...
schedule function generated:npc/simon/2-07 144t
