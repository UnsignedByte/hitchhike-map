...
# Dialogue line #7-15: speak and make noise.
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#6bdfc3","bold":true},"> ",{"text":"Good luck, my friend!"}]
...
schedule function generated:npc/simon/7-end 20t
