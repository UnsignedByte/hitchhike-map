...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Follow me and I'll get you on your way up that mountain."}]
...
# tp @e[type=villager,tag=npc-simon, limit=1] 929.50 64 197.50 135 0
