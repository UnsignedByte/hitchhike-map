...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Ahh","italic":true},{"text":", that was pretty good. I really do appreciate it. You can keep the change, don't worry."}]
...
schedule function generated:npc/simon/4-8 156t
