...
execute at @e[tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"... Okay, it did ask me "},{"text":"once","italic":true},{"text":" but it didn't even ask me to confirm after I accidentally clicked OK. Who does that?"}]
...
schedule function generated:npc/simon/2-12 192t
