...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#6bdfc3","bold":true},"> ",{"text":"Amazing, isn't it? It takes a keen eye to notice the beautifully detailed ridges along the surface, almost vascular in their branching pattern."}]
