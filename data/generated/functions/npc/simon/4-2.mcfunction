...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Notice the beautiful tumescent shape? I chose it myself."}]
...
schedule function generated:npc/simon/4-3 114t
