...
execute at @e[tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"I was too busy admiring my "},{"text":"1997 Limited Edition Honda Civic","color":"dark_red","bold":true},{"text":". 17 million Bck by the way, not that you would understand wealth of that size."}]
