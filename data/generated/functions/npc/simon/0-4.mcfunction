...
execute at @e[tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"You don't look at all prepared for the elements, and I don't need more of your type showing up when you end up needing help on the mountain."}]
