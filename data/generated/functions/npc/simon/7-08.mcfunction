...
execute at @e[tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Here you go, I've even printed out the map for you. Pick it up on the left and make sure you take a good look at it before you go up."}]
...
summon item 964.5 75.5 197.5 {Item:{Count: 1b, id: "minecraft:filled_map", tag: {display: {Name: '{"text":"Mountain Trail Map","color":"#25cc8c","bold":true}', Lore: ['{"text":"A Map.","color":"gray"}']}, Enchantments: [{}], map: 0}}}
