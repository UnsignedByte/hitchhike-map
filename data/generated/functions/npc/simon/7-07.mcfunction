...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Feel free to relax, but don't touch anything, please. I don't want your grubby hands on my expensive furniture."}]
...
schedule function generated:npc/simon/7-08 192t
