...
# Dialogue line #7-13: speak and make noise.
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#6bdfc3","bold":true},"> ",{"text":"Alright, the trail starts right through this gate."}]
...
schedule function generated:npc/simon/7-13 48t
