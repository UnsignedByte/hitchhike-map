...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Don't give me any of that \"processed tap water\" or \"mineral water\" "},{"text":"normal","italic":true},{"text":" people drink."}]
...
schedule function generated:npc/simon/2-17 100t
