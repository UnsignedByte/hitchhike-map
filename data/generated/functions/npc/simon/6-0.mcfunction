...
execute at @e[tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Where's my LaCroix?? I told you I wouldn't talk to you unless you got it."}]
...
schedule function generated:npc/simon/6-1 132t
