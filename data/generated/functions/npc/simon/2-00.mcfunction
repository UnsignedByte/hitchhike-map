...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Oh, it's you, the plebeian. I didn't see you there."}]
...
schedule function generated:npc/simon/2-01 68t
