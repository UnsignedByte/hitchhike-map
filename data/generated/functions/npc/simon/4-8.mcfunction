...
execute at @e[tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Consider it a gift; I'm just generous like that."}]
...
schedule function generated:npc/simon/4-9 90t
