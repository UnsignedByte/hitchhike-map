...
# Dialogue line #2-23: speak and make noise.
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"I better not see you back here without it."}]
...
schedule function generated:npc/simon/2-23 90t
