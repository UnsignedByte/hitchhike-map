...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"What, you don't have money to buy clothes? Just go "},{"text":"scrounging for coins at the fountain","italic":true},{"text":" or whatever it is you people do."}]
