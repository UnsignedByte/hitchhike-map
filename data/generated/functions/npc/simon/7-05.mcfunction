...
execute at @e[tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Oh wow, it actually works! What a surprise."}]
...
schedule function generated:npc/simon/7-06 72t
