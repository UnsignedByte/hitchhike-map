...
# Dialogue line #7-6: speak and make noise.
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Oh wow, it actually works! I never thought I'd get this back."}]
...
schedule function generated:npc/simon/7-06 64t
