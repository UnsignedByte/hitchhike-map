...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"Don't worry, if you work as hard as I do, one day you might be almost as successful too."}]
...
schedule function generated:npc/simon/2-03 156t
