...
execute at @e[type=villager,tag=npc-simon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Simon Ursus Stephens","color":"#85deb1","bold":true},"> ",{"text":"At least I can respect that. Maybe you might be successful like me if you keep that up."}]
...
schedule function generated:npc/simon/2-05 162t
