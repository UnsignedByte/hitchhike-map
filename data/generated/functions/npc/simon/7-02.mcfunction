...
clear @a minecraft:daylight_detector{display: {Name: '{"text":"SD Card (Fixed)","color":"#d6679f","bold":true}', Lore: ['{"text":"An SD Card.","color":"blue"}']}, HideFlags: 127, Enchantments: [{id:"minecraft:unbreaking",lvl:1s}]} 2147483647
data modify entity @e[type=villager,tag=npc-simon, limit=1] HandItems[0] set value {Count: 1b, id: "minecraft:daylight_detector", tag: {display: {Name: '{"text":"SD Card (Fixed)","color":"#d6679f","bold":true}', Lore: ['{"text":"An SD Card.","color":"blue"}']}, HideFlags: 127, Enchantments: [{id:"minecraft:unbreaking",lvl:1s}]}}
