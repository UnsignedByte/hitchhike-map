...
execute at @e[tag=npc-birthdayboy, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Mat Norma","bold":true},"> ",{"text":"Don't worry, its only been an hour, it's not that bad."}]
