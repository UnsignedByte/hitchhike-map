...
execute at @e[tag=npc-birthdayboy, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Matt Norma","color":"#de4b40","bold":true},"> ",{"text":"Don't worry, its only been an hour, it's not that bad."}]
...
schedule function generated:npc/birthdayboy/0-3 78t
