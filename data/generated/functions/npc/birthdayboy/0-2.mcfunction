...
execute at @e[tag=npc-birthdayboy, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Matt Norma","color":"#de4b40","bold":true},"> ",{"text":"You must have been late, I'm sure everyone else is coming soon too."}]
...
schedule function generated:npc/birthdayboy/0-3 150t
