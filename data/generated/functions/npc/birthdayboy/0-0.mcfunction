...
execute at @e[type=villager,tag=npc-birthdayboy, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Matt Norma","color":"#de4b40","bold":true},"> ",{"text":"Oh hi! Are you here for my birthday party? Is my mom with you?"}]
...
schedule function generated:npc/birthdayboy/0-1 102t
