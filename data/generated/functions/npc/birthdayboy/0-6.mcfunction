...
execute at @e[type=villager,tag=npc-birthdayboy, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Matt Norma","color":"#de4b40","bold":true},"> ",{"text":"... You're busy? It's someone else's birthday?"}]
...
schedule function generated:npc/birthdayboy/0-7 100t
