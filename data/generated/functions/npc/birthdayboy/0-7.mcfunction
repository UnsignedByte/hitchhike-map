...
execute at @e[type=villager,tag=npc-birthdayboy, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Matt Norma","color":"#de4b40","bold":true},"> ",{"text":"Sorry to bother you then... Have a nice day!"}]
...
schedule function generated:npc/birthdayboy/0-end 52t
