...
execute at @e[tag=npc-birthdayboy, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Matt Norma","color":"#de4b40","bold":true},"> ",{"text":"Don't worry, more cake to myself! Hahaha."}]
...
schedule function generated:npc/birthdayboy/1-end 66t
