...
execute at @e[type=villager,tag=npc-birthdayboy, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Matt Norma","color":"#de4b40","bold":true},"> ",{"text":"I know, I know, my birthday was last week, but everyone was busy so I'm having another party today!"}]
...
schedule function generated:npc/birthdayboy/0-2 108t
