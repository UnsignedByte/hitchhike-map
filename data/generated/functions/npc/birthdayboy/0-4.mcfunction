...
execute at @e[tag=npc-birthdayboy, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Matt Norma","color":"#de4b40","bold":true},"> ",{"text":"... Oh, you aren't here for my birthday?"}]
...
schedule function generated:npc/birthdayboy/0-5 60t
