...
execute at @e[tag=npc-cashier, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Paoule Enrique","color":"#eb7060","bold":true},"> ",{"text":"If you want to buy anything, just drop it off here on the conveyor."}]
