...
execute at @e[tag=npc-cashier, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Paoule Enrique","color":"#eb7060","bold":true},"> ",{"interpret":true,"nbt":"success_msg","storage":"hitchhike:safeway"}]
...
schedule function generated:npc/cashier/1-end 24t
