...
execute at @e[tag=npc-cashier, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Henry","color":"#eb7060","bold":true},"> ",{"interpret":true,"nbt":"success_msg","storage":"hitchhike:safeway"}]
