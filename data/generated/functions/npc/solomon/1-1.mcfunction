...
execute at @e[type=villager,tag=npc-solomon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Solomon Quint","color":"#732424","bold":true},"> ",{"text":"Don't mind me, I'll be totally focused on this computer."}]
...
schedule function generated:npc/solomon/1-end 90t
