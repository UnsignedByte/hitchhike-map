...
give @a[tag=victim-of-dialogue-by-solomon, limit=1] minecraft:black_candle{Enchantments: [{id:"minecraft:unbreaking",lvl:1s}], display: {Lore: ['{"text":"Runs Android 5.0.2 \\"Lollipop\\".","color":"gray"}','{"text":"Use it by right clicking","color":"blue"}','{"text":"while standing still.","color":"blue"}'], Name: '{"text":"Motorola Moto G 2","color":"gray"}'}, HideFlags: 127, phone: 1b, androidphone: 1b} 1
