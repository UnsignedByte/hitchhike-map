...
execute at @e[type=villager,tag=npc-solomon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Solomon Quint","color":"#732424","bold":true},"> ",{"text":"Imagine if I let you get the key to the electrical box from the chest in the basement, climbed up that tower, and got hurt doing so!"}]
...
schedule function generated:npc/solomon/0-8 234t
