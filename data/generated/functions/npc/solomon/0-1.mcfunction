...
execute at @e[tag=npc-solomon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Solomon Quint","color":"#732424","bold":true},"> ",{"text":"You must be tired, come on in and make yourself at home."}]
...
schedule function generated:npc/solomon/0-2 114t
