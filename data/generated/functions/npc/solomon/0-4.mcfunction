...
execute at @e[type=villager,tag=npc-solomon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Solomon Quint","color":"#732424","bold":true},"> ",{"text":"A lightning strike must have shorted the electrical components at the top."}]
...
schedule function generated:npc/solomon/0-5 126t
