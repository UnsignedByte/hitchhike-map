...
execute at @e[type=villager,tag=npc-solomon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jason Quint","color":"#732424","bold":true},"> ",{"text":"Feel free to hang around here for a bit. Looks like I don't need to do any work after all!"}]
...
schedule function generated:npc/solomon/2-2 116t
