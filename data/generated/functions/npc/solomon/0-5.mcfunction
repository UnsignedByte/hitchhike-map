...
execute at @e[type=villager,tag=npc-solomon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jason Quint","color":"#732424","bold":true},"> ",{"text":"You say you can fix it?"}]
...
schedule function generated:npc/solomon/0-6 32t
