...
execute at @e[type=villager,tag=npc-solomon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jason Quint","color":"#732424","bold":true},"> ",{"text":"... Huh? Who're you? Who let you up here in the "},{"text":"middle of the night","italic":true},{"text":"?"}]
...
schedule function generated:npc/solomon/0-1 76t
