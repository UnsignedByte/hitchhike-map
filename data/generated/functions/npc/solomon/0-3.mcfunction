...
execute at @e[type=villager,tag=npc-solomon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Solomon Quint","color":"#732424","bold":true},"> ",{"text":"...Internet, huh. Well, sorry to spoil the mood, but that tower over there isnt really working either."}]
...
schedule function generated:npc/solomon/0-end 168t
