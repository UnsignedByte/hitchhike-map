...
execute at @e[type=villager,tag=npc-solomon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jason Quint","color":"#732424","bold":true},"> ",{"text":"That wouldn't do, would it? Sorry, but I guess you'll have to make your way back down the mountain..."}]
