...
execute at @e[type=villager,tag=npc-solomon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jason Quint","color":"#b68bdd","bold":true},"> ",{"text":"That wouldn't do, would it? Sorry, but I guess you'll have to make your way back down the mountain..."}]
...
schedule function generated:npc/solomon/0-9 116t
