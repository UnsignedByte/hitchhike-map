...
execute at @e[type=villager,tag=npc-solomon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jason Quint","color":"#b68bdd","bold":true},"> ",{"text":"Back already? Great news, the internet just started working again! Lucky you."}]
...
schedule function generated:npc/solomon/2-1 88t
