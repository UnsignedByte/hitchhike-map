...
execute at @e[type=villager,tag=npc-solomon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jason Quint","color":"#732424","bold":true},"> ",{"text":"If you need help, I'll be right here, completely focused on my computer and unable to hear something like the opening of any basement doors."}]
...
schedule function generated:npc/solomon/0-end 176t
