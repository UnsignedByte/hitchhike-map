...
execute at @e[type=villager,tag=npc-solomon, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Solomon Quint","color":"#732424","bold":true},"> ",{"text":"Sorry, I can't "},{"text":"let","italic":true},{"text":" you do something that dangerous, or I would get in trouble."}]
...
schedule function generated:npc/solomon/0-7 144t
