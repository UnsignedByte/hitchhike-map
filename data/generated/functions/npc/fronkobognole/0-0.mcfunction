...
execute at @e[tag=npc-fronkobognole, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Francis O'Bognole","color":"#f0c84d","bold":true},"> ",{"text":"Oh, "},{"text":"heh heh","italic":true},{"text":"... you must have caught me deep in the middle of reading."}]
