...
execute at @e[tag=npc-__safeway_lacroix, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",[{"text":"La Croix Sparkling Water","color":"dark_aqua","italic":true},{"text":" (9.99B)","bold":false,"italic":false,"strikethrough":false,"obfuscated":false,"underlined":false}],"> ",{"text":"taken"}]
