...
execute at @e[tag=npc-__safeway_seaweed, limit=1] run tag @a[distance=..50] add npc-eavesdropper
...
give @a[tag=victim-of-dialogue-by-__safeway_seaweed, limit=1] minecraft:paper{cost: 199, display: {Name: '{"text":"Dried Seaweed","bold":false,"color":"#19691c"}', Lore: ["{\"text\":\"Just add hot water.\",\"italic\":false,\"color\":\"dark_gray\"}","{\"text\":\"\"}","{\"text\":\"Unsold (1.99B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, store: "safeway", item: "seaweed", sold: 0b} 1
