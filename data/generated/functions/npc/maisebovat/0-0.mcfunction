...
execute at @e[tag=npc-maisebovat, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Mary Bennett","color":"#6f9ee8","bold":true},"> ",{"text":"How did you get in here??"}]
...
schedule function generated:npc/maisebovat/0-1 48t
