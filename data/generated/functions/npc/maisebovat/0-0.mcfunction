...
execute at @e[tag=npc-maisebovat, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Maise Bovat","bold":true},"> ",{"text":"test"}]
...
schedule function generated:npc/maisebovat/0-end 6t
