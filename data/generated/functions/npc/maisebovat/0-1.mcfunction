...
execute at @e[tag=npc-maisebovat, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Mary Bennett","color":"#6f9ee8","bold":true},"> ",{"text":"I told my dad not to let anyone in!"}]
...
schedule function generated:npc/maisebovat/0-2 60t
