...
execute at @e[tag=npc-maisebovat, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Maise Bovat","bold":true},"> ",{"text":"Well, congratulations on finding me, yada yada..."}]
