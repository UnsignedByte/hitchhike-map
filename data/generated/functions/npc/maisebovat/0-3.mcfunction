...
execute at @e[tag=npc-maisebovat, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Mary Bennett","color":"#6f9ee8","bold":true},"> ",{"text":"Well, congratulations on finding me, yada yada..."}]
...
schedule function generated:npc/maisebovat/0-4 90t
