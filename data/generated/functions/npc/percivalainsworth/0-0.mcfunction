...
execute at @e[tag=npc-percivalainsworth, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Percival Ainsworth","bold":true},"> ",{"text":"Ugh, what do you want? Can't you see I'm studying here?"}]
