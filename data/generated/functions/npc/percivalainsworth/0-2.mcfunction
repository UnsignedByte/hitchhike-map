...
execute at @e[tag=npc-percivalainsworth, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Percival Ainsworth","bold":true},"> ",{"text":"Whatever, just tell them you hung out with me and collect your payment."}]
