...
give @a[tag=victim-of-dialogue-by-egg, limit=1] minecraft:paper{cost: 9, pos: '914.5 63.625 -152.8', display: {Name: '{"text":"Egg","bold":false,"color":"#f2e1aa"}', Lore: ["{\"text\":\"A Dollar a Dozen\",\"italic\":false,\"color\":\"#d9ac59\"}","{\"text\":\"\"}","{\"text\":\"Unsold (0.09B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, sold: 0b} 1
