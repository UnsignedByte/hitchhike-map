...
give @a[tag=victim-of-dialogue-by-bamboo, limit=1] minecraft:paper{cost: 119, pos: '915.5 62.75 -153.5', display: {Name: '{"text":"Bamboo Shoots","bold":false,"color":"#16ba2c"}', Lore: ["{\"text\":\"Rich in fiber.\",\"italic\":false,\"color\":\"#0d8c1e\"}","{\"text\":\"\"}","{\"text\":\"Unsold (1.19B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, sold: 0b} 1
