...
execute at @e[tag=npc-berry_sale, limit=1] run tellraw @a[distance=..50] ["<",{"text":"Apple (${toCost(item.store.unsold.apple.tag.cost)})","color":"#ff0000","bold":true},"> ",{"text":"taken"}]
