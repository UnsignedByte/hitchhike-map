...
execute at @e[tag=npc-boba, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Brett Chen","color":"#d65454","bold":true},"> ",{"text":"Welcome to SiTea, the best boba shop in town!"}]
