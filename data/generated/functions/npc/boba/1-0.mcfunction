...
execute at @e[type=villager,tag=npc-boba, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Brett Chen","color":"#d65454","bold":true},"> ",{"interpret":true,"nbt":"welcome.boba","storage":"hitchhike:stores"}]
