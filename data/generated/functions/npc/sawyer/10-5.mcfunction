...
# Dialogue line #10-6: speak and make noise.
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Also, I had fun too..."}]
...
schedule function generated:npc/sawyer/10-end 28t
