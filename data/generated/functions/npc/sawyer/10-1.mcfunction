...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Let me take you back out and I'll analyze the data next."}]
...
schedule function generated:npc/sawyer/10-2 108t
