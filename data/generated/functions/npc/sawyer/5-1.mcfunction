...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#8de359","bold":true},"> ",{"text":"Anyways, thanks for the mouse."}]
...
setblock 949 71 0 stone_button[face=floor,facing=east,powered=false]
