...
give @a[tag=victim-of-dialogue-by-sawyer, limit=1] minecraft:daylight_detector{display: {Name: '{"text":"SD Card (Fixed)","color":"#d6679f","bold":true}', Lore: ['{"text":"An SD Card.","color":"blue"}']}, HideFlags: 127, Enchantments: [{id:"minecraft:unbreaking",lvl:1s}]} 1
