...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"It's booted up; I'll take a look now."}]
...
schedule function generated:npc/sawyer/3-7 100t
