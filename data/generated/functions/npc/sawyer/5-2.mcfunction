...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Try throwing them out with \"Q\"... throwing things at enemies often works, after all."}]
...
schedule function generated:npc/sawyer/5-3 120t
