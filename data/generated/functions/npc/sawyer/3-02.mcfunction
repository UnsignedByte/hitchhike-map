...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Hmm, an SD card... It's corrupted, you say?"}]
...
schedule function generated:npc/sawyer/3-03 54t
