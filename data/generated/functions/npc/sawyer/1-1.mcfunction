...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#8de359","bold":true},"> ",{"text":"Why are you so desperate for internet? Do you have to talk to someone or something?"}]
...
schedule function generated:npc/sawyer/1-2 116t
