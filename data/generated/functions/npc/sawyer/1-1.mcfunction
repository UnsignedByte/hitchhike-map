...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Why are you so desperate for internet? Do you have to talk to someone or something?"}]
...
schedule function generated:npc/sawyer/1-2 174t
