...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Unfortunately I am unable to fix the power grid through my computer."}]
...
schedule function generated:npc/sawyer/1-2 126t
