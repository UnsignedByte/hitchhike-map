...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#8de359","bold":true},"> ",{"text":"If you could follow it there and take care of the source of the corruption there, I can fix up more of the SD card for you, or something."}]
...
schedule function generated:npc/sawyer/7-7 176t
