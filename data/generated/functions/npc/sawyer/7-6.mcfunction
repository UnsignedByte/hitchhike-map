...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"If you could follow it there and take care of the source of the corruption there, I can fix up more of the SD card for you!"}]
...
schedule function generated:npc/sawyer/7-7 240t
