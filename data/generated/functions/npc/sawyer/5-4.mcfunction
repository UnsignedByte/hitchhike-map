...
# Dialogue line #5-5: speak and make noise.
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#8de359","bold":true},"> ",{"text":"Did I mention you'll be the one doing most of it?"}]
...
schedule function generated:npc/sawyer/5-5 64t
