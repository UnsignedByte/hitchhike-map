...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Well, I have no idea. Why don't you wait until the connection is back?"}]
...
schedule function generated:npc/sawyer/0-end 132t
