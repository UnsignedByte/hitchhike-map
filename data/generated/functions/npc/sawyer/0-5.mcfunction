...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#8de359","bold":true},"> ",{"text":"Well, I have no idea. Why don't you wait until the connection is back?"}]
...
schedule function generated:npc/sawyer/0-end 88t
