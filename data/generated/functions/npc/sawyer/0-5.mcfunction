...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Well, I have no idea. Maybe turn it off or on again, or something like that."}]
...
schedule function generated:npc/sawyer/0-end 150t
