...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Who knows? I would recommend you turn it off and on again... your internet, I mean. Not my electricity."}]
...
schedule function generated:npc/sawyer/0-6 186t
