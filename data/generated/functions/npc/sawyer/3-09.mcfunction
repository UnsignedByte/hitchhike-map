...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Come to think of it, since you have so much time anyways, could you help me get my computer mouse?"}]
...
schedule function generated:npc/sawyer/3-10 186t
