...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#8de359","bold":true},"> ",{"text":"Sorry, give me some time, I'm still working on it."}]
...
schedule function generated:npc/sawyer/4-1 56t
