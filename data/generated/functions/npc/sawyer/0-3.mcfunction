...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"That might have something to do with the sudden loss of electricity in my house..."}]
...
schedule function generated:npc/sawyer/0-4 138t
