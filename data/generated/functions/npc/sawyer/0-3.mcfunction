...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Storm killed your internet? So you're here for my help again, huh."}]
...
schedule function generated:npc/sawyer/0-4 120t
