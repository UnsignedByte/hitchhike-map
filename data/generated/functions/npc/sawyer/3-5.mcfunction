...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"I'm booting up my computer and I'll take a look at it after, but this will probably take a while."}]
...
schedule function generated:npc/sawyer/3-6 174t
