...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"I see you've taken care of the first source, so I guess I should congratulate you."}]
...
schedule function generated:npc/sawyer/8-1 180t
