...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"You should see portions of the card being fixed up soon."}]
...
schedule function generated:npc/sawyer/8-2 114t
