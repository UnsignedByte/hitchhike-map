...
# Dialogue line #9-1: speak and make noise.
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Alright, that's 2/3 done. Good job."}]
...
schedule function generated:npc/sawyer/9-1 32t
