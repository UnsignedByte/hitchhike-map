...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#8de359","bold":true},"> ",{"text":"How'd I know it was a her? ... Just my luck, I guess?"}]
...
schedule function generated:npc/sawyer/3-02 48t
