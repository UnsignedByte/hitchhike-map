...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"How'd I know it was a she? "},{"text":"Just my luck, I guess.","italic":true}]
...
schedule function generated:npc/sawyer/3-02 72t
