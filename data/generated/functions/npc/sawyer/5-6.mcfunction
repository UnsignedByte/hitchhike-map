...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Welcome to the "},{"text":"waiting room","italic":true},{"text":". Please be patient while I load the SD card data into memory... My computer is slow so watch out for lag. Sorry."}]
...
schedule function generated:npc/sawyer/5-7 168t
