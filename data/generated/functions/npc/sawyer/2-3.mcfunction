...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Well, the mountain is pretty unmistakeable. It's toward the south, if you can't find it."}]
...
schedule function generated:npc/sawyer/2-4 104t
