...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"I can't exactly follow you there, you know I don't leave the house."}]
...
schedule function generated:npc/sawyer/2-5 132t
