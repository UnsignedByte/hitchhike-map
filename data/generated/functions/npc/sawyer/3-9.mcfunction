...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"I'll try to work on it in the meantime, but vim keybindings can only get you so far... (and by far I mean everywhere, but still.)"}]
...
schedule function generated:npc/sawyer/3-end 204t
