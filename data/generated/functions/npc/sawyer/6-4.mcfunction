...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#8de359","bold":true},"> ",{"text":"It seems a big portion of the card is corrupted, which might make it dangerous, so I would recommend you take some tools with you."}]
...
schedule function generated:npc/sawyer/6-5 168t
