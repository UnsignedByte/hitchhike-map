...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#8de359","bold":true},"> ",{"text":"Figures. You're only ever here for my help."}]
...
schedule function generated:npc/sawyer/3-05 52t
