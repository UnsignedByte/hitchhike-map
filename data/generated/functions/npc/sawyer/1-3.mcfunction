...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Or you could just visit them, but I guess they must not live around here, huh."}]
...
schedule function generated:npc/sawyer/1-4 144t
