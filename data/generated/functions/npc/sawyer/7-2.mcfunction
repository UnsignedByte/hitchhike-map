...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Try dropping your tools... Throwing things at enemies often works, after all."}]
...
schedule function generated:npc/sawyer/7-3 120t
