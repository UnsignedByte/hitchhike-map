...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Most of the card is fixed up, just one sector left to finish off."}]
...
schedule function generated:npc/sawyer/7-end 108t
