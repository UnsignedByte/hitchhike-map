...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"You sure took your time, huh... Not that I was checking the clock or anything, I just noticed."}]
...
schedule function generated:npc/sawyer/5-1 162t
