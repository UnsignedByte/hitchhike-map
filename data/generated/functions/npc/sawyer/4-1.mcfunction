...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"Anyways, I've also loaded in some old models into the waiting room that you can take before you get into the card."}]
...
schedule function generated:npc/sawyer/4-2 234t
