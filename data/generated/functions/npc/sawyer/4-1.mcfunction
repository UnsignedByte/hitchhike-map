...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"I should be finished by the time you get me my mouse."}]
...
schedule function generated:npc/sawyer/4-end 102t
