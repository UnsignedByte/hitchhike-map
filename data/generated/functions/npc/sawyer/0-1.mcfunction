...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"I guess you couldn't really text with the storm taking everything out but you could've at least knocked."}]
...
schedule function generated:npc/sawyer/0-2 186t
