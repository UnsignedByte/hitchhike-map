...
execute at @e[tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#4fa1a7","bold":true},"> ",{"text":"You never seem this eager to contact me...","italic":true}]
...
schedule function generated:npc/sawyer/2-3 84t
