...
execute at @e[type=villager,tag=npc-sawyer, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Chris Sawyer","color":"#8de359","bold":true},"> ",{"text":"You're never this eager to talk to me..."}]
...
schedule function generated:npc/sawyer/2-3 52t
