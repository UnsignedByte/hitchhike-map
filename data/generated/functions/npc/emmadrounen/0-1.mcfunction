...
execute at @e[type=villager,tag=npc-emmadrounen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Emma Drounen","color":"#0d559e","bold":true},"> ",{"text":"You keep splashing -blblb- and you'll expose -blb- hiding spot!"}]
...
schedule function generated:npc/emmadrounen/0-2 60t
