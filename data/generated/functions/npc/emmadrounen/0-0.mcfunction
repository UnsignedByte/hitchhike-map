...
execute at @e[type=villager,tag=npc-emmadrounen, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Emma Drounen","color":"#0d559e","bold":true},"> ",{"text":"Hey! BLBLB- Get -blb- of the water!"}]
...
schedule function generated:npc/emmadrounen/0-1 24t
