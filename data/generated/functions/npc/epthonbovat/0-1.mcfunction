...
execute at @e[type=villager,tag=npc-epthonbovat, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ethan Bennett","color":"#17130f","bold":true},"> ",{"text":"Breaking and entering is a crime, I hope you realize!"}]
