...
execute at @e[tag=npc-epthonbovat, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Epthon Bovat","bold":true},"> ",{"text":"Hey! I know you're playing that stupid hide and seek thing, but you can't just go around breaking into people's homes!"}]
...
schedule function generated:npc/epthonbovat/0-1 216t
