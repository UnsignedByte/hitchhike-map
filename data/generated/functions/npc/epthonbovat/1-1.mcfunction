...
execute at @e[tag=npc-epthonbovat, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Ethan Bennett","color":"#17130f","bold":true},"> ",{"text":"Get OUT!","bold":true}]
...
schedule function generated:npc/epthonbovat/1-end 18t
