...
execute at @e[tag=npc-muller, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Elbert Muller","color":"#608082","bold":true},"> ",{"text":"Haven't you heard? I'm part of the big game of hide and seek going on."}]
...
schedule function generated:npc/muller/0-2 132t
