...
execute at @e[tag=npc-muller, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Elbert Muller","color":"#608082","bold":true},"> ",{"text":"Try to leave this area soon before someone takes notice. Have a nice one!"}]
...
schedule function generated:npc/muller/0-end 174t
