...
execute at @e[tag=npc-muller, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Egress Muller","color":"#608082","bold":true},"> ",{"text":"Woah, hey there. What're you doing all the way up here? You don't look like a security guard."}]
