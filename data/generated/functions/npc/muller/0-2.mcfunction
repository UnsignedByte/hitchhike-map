...
execute at @e[tag=npc-muller, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Egress Muller","color":"#608082","bold":true},"> ",{"text":"Please don't let anyone know I'm here."}]
