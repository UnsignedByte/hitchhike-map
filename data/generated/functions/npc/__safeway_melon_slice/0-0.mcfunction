...
execute at @e[tag=npc-__safeway_melon_slice, limit=1] run tag @a[distance=..25] add npc-eavesdropper
...
schedule function generated:npc/__safeway_melon_slice/0-end 24t
