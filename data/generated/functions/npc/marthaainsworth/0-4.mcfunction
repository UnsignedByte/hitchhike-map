...
execute at @e[tag=npc-marthaainsworth, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Martha Ainsworth","color":"#91faf2","bold":true},"> ",{"text":"Thank you for sticking with him, I know he can be a little difficult sometimes."}]
...
schedule function generated:npc/marthaainsworth/0-end 138t
