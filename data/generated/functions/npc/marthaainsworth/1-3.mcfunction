...
execute at @e[tag=npc-marthaainsworth, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Martha Ainsworth","color":"#91faf2","bold":true},"> ",{"text":"Well, ta-ta, and have fun with Percy! I sure hope he isn't "},{"text":"studying","italic":true},{"text":" again; that's all he ever seems to do."}]
...
schedule function generated:npc/marthaainsworth/1-end 180t
