...
execute at @e[type=villager,tag=npc-marthaainsworth, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Martha Ainsworth","color":"#91faf2","bold":true},"> ",{"text":"Well, anyways, you kiddos have fun playing, and don't hesitate to ask me if you need anything."}]
...
schedule function generated:npc/marthaainsworth/0-4 112t
