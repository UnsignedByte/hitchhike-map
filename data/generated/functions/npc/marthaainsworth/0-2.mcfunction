...
execute at @e[type=villager,tag=npc-marthaainsworth, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Martha Ainsworth","color":"#91faf2","bold":true},"> ",{"text":"I'm so glad he seems to have so many friends now! It's almost a different friend every day."}]
...
schedule function generated:npc/marthaainsworth/0-3 104t
