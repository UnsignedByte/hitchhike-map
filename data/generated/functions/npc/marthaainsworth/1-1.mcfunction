...
execute at @e[type=villager,tag=npc-marthaainsworth, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Martha Ainsworth","color":"#91faf2","bold":true},"> ",{"text":"I keep forgetting how confusing this house can be... The stairs up are in the garage. (of all places, I know!)"}]
...
schedule function generated:npc/marthaainsworth/1-2 132t
