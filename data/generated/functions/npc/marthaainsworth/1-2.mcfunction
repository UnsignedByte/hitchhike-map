...
execute at @e[tag=npc-marthaainsworth, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Martha Ainsworth","color":"#91faf2","bold":true},"> ",{"text":"I don't know what they were thinking when designing this darn place."}]
...
schedule function generated:npc/marthaainsworth/1-3 102t
