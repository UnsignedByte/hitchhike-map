...
give @a[tag=victim-of-dialogue-by-beet, limit=1] minecraft:paper{cost: 99, pos: '915.52 64.5 -156.5', display: {Name: '{"text":"Beet","bold":false,"color":"#7a1f3d"}', Lore: ["{\"text\":\"Beet red\",\"italic\":false,\"color\":\"#4d0000\"}","{\"text\":\":flushed:\",\"italic\":false,\"color\":\"#4d0000\"}","{\"text\":\"\"}","{\"text\":\"Unsold (0.99B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, sold: 0b} 1
