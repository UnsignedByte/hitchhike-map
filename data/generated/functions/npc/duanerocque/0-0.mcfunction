...
execute at @e[tag=npc-duanerocque, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Dwight Rocque","color":"#e6e6e6","bold":true},"> ",{"text":"Another one of you? Alright, alright, the food is almost done, be patient!"}]
...
schedule function generated:npc/duanerocque/0-1 144t
