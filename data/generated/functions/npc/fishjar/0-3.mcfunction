...
execute at @e[tag=npc-fishjar, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jared Majors","color":"#bdaa77","bold":true},"> ",{"text":"Use your tokens to guess the amount of money in the jar; 1 BuckeT coin (BTC) represents 1 Bck."}]
...
schedule function generated:npc/fishjar/0-4 156t
