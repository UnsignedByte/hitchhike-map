...
execute at @e[tag=npc-fishjar, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Cullus Major","color":"#bdaa77","bold":true},"> ",{"text":"Use your tokens to guess the amount of money in the jar; 1 BovToken coin (BTC) represents 1 Bov."}]
