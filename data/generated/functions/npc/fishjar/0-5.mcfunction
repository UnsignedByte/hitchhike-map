...
execute at @e[tag=npc-fishjar, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Cullus Major","color":"#bdaa77","bold":true},"> ",{"text":"When you're ready to play, come talk to me and I'll fill that jar up for you."}]
...
schedule function generated:npc/fishjar/0-end 132t
