...
execute at @e[type=villager,tag=npc-fishjar, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jared Majors","color":"#bdaa77","bold":true},"> ",{"text":"Welp, unfortunately, that's it folks!"}]
...
schedule function generated:npc/fishjar/4-1 36t
