...
execute at @e[type=villager,tag=npc-fishjar, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jared Majors","color":"#bdaa77","bold":true},"> ",{"text":"Guess the total value in the jar, and place your bets to the right side."}]
...
schedule function generated:npc/fishjar/1-2 88t
