...
execute at @e[tag=npc-fishjar, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Cullus Major","color":"#bdaa77","bold":true},"> ",{"text":"Best of luck! Come back again when you are ready to find out the real total."}]
...
schedule function generated:npc/fishjar/1-end 150t
