...
execute at @e[type=villager,tag=npc-fishjar, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jared Majors","color":"#bdaa77","bold":true},"> ",{"text":"If you are within 2.50 Bck of the real total, you get everything in the jar! That's right, all of it!"}]
...
schedule function generated:npc/fishjar/0-5 108t
