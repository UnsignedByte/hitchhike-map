...
execute at @e[tag=npc-fishjar, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Cullus Major","color":"#bdaa77","bold":true},"> ",{"text":"If you are within 2.50 Bov of the real total, you get everything in the jar!"}]
...
schedule function generated:npc/fishjar/0-5 138t
