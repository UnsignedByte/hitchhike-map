...
execute at @e[type=villager,tag=npc-fishjar, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jared Majors","color":"#bdaa77","bold":true},"> ",{"text":"Make sure to choose carefully, and best of luck!"}]
...
schedule function generated:npc/fishjar/1-end 60t
