...
execute at @e[tag=npc-fishjar, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Cullus Major","color":"#bdaa77","bold":true},"> ",{"text":"Only 10b (0.10 Bov) a token!"}]
...
schedule function generated:npc/fishjar/0-3 30t
