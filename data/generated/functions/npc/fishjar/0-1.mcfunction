...
execute at @e[type=villager,tag=npc-fishjar, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Jared Majors","color":"#bdaa77","bold":true},"> ",{"text":"To get tokens, simply place your cash in the chest right here!"}]
...
schedule function generated:npc/fishjar/0-2 64t
