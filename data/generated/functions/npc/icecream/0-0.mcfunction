...
execute at @e[type=villager,tag=npc-icecream, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Luke Toser","color":"#a2f092","bold":true},"> ",{"text":"Welcome to the Cream Bucket!"}]
...
schedule function generated:npc/icecream/0-1 36t
