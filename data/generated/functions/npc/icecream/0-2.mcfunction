...
execute at @e[type=villager,tag=npc-icecream, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Luke Toser","color":"#a2f092","bold":true},"> ",{"text":"We hope to see you another day!"}]
...
schedule function generated:npc/icecream/0-end 48t
