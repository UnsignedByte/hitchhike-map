...
execute at @e[tag=npc-lucky, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Lucky Goldstein","color":"#3db330","bold":true},"> ",{"text":"Bucky said it would be crazy to hide in someone else's house, especially Sam's- but it's genius!"}]
...
schedule function generated:npc/lucky/0-3 186t
