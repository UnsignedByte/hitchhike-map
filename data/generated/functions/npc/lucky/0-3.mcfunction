...
execute at @e[type=villager,tag=npc-lucky, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Lucky Goldstein","color":"#3db330","bold":true},"> ",{"text":"At least, more genius than a rooftop pool..."}]
...
schedule function generated:npc/lucky/0-4 60t
