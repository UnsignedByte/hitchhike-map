...
execute at @e[tag=npc-lucky, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Lucky Goldstein","color":"#3db330","bold":true},"> ",{"text":"SHH!","italic":true},{"text":" Don't let Sam hear me! She'll definitely kick me out."}]
