...
execute at @e[tag=npc-katherine, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Katherine Au-Flauge","color":"#3a453a","bold":true},"> ",{"text":"Where's Cam? Probably climbing the neighbor's tree or whatever crazy things he gets up to outside."}]
...
schedule function generated:npc/katherine/0-4 162t
