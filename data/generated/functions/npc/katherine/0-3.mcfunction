...
execute at @e[tag=npc-katherine, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Katherine Au-Flauge","bold":true},"> ",{"text":"Where's Cam? Probably climbing the neighbor's tree or whatever crazy things he gets up to outside."}]
