...
execute at @e[tag=npc-katherine, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Katherine Au-Flauge","color":"#3a453a","bold":true},"> ",{"text":"I've heard he joined that \"Hide and Seek\" thing going on, so maybe he's hiding?"}]
