...
execute at @e[type=villager,tag=npc-katherine, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Katherine Au-Flauge","color":"#3a453a","bold":true},"> ",{"text":"Hey there, are you looking for Cam? He ran off to who knows where again."}]
...
schedule function generated:npc/katherine/0-1 92t
