...
execute at @e[tag=npc-katherine, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Katherine Au-Flauge","bold":true},"> ",{"text":"Hey there, are you looking for Cam? That brat ran off to who knows where again."}]
...
schedule function generated:npc/katherine/0-1 144t
