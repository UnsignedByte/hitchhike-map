...
execute at @e[tag=npc-katherine, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Katherine Au-Flauge","color":"#3a453a","bold":true},"> ",{"text":"Those darn things just won't stop meowing, and it's driving me insane."}]
...
schedule function generated:npc/katherine/0-3 108t
