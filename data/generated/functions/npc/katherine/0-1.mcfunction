...
execute at @e[tag=npc-katherine, limit=1] run tellraw @a[tag=npc-eavesdropper] ["<",{"text":"Katherine Au-Flauge","bold":true},"> ",{"text":"If you find him, could you tell him to get back down here and feed the cats?"}]
...
schedule function generated:npc/katherine/0-2 132t
