...
give @a[tag=victim-of-dialogue-by-__safeway_egg, limit=1] minecraft:paper{cost: 9, pos: '914 63.625 -152.5', display: {Name: '{"text":"Egg","bold":false,"color":"#f2e1aa"}', Lore: ["{\"text\":\"A Dollar a Dozen\",\"italic\":true,\"color\":\"#d9ac59\"}","{\"text\":\"\"}","{\"text\":\"Unsold (0.09B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, store: "safeway", sold: 0b} 1
