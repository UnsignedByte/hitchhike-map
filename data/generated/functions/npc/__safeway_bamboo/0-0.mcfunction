...
execute at @e[tag=npc-__safeway_bamboo, limit=1] run tag @a[distance=..50] add npc-eavesdropper
...
give @a[tag=victim-of-dialogue-by-__safeway_bamboo, limit=1] minecraft:paper{cost: 119, pos: '915.5 62.75 -153.5', display: {Name: '{"text":"Bamboo Shoots","bold":false,"color":"#16ba2c"}', Lore: ["{\"text\":\"Rich in fiber.\",\"italic\":true,\"color\":\"#0d8c1e\"}","{\"text\":\"\"}","{\"text\":\"Unsold (1.19B)\",\"italic\":true,\"color\":\"dark_gray\"}"]}, store: "safeway", sold: 0b} 1
