...
summon armor_stand 0.17261081 68.80135524 0.26953125 {Pose: {Head: [13.149557753093044f, -180f, -180f]}, Tags: ["item_holder"], ArmorItems: [{},{},{},{id:"minecraft:glass_pane", Count:1b}], Invulnerable: 1b, Invisible: 1b, NoGravity: 1b}
