...
data modify storage generated:quest_book current[9] set value '{"text":"","color":"dark_green","bold":false,"underlined":false,"hoverEvent":{"action":"show_text","contents":{"text":"Craft and light a campfire at Herb\'s firepit."}},"extra":[{"text":"Fire-lighting","italic":true}," (",{"score":{"name":"campfire","objective":"quest-status"}},"%)"]}'
