scoreboard players operation oq-1-0-0 q-1 = q-1-0-0 q-1
scoreboard players set q-1-0-0 q-1 0
scoreboard players operation q-1-0-0 q-1 += q-1-0-0-0 q-1
scoreboard players operation q-1-0-0 q-1 += q-1-0-0-1 q-1
scoreboard players operation q-1-0-0 q-1 += q-1-0-0-2 q-1
scoreboard players operation q-1-0-0 q-1 /= 500 const
