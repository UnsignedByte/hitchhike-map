...
scoreboard players operation q-4 q-4 *= 100 const
scoreboard players operation q-4 q-4 *= undefined const
scoreboard players operation q-4 q-4 /= 1 const
execute unless score q-4 q-4 matches ..undefined run scoreboard players set q-4 q-4 undefined
