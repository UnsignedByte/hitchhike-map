...
execute as @a at @s if entity @s[x=906,y=64,z=186,dx=13,dz=5,dy=1] run scoreboard players add @s q-3-0-3 1
...
scoreboard players operation q-3-0-3 q-3 /= 100 const
execute unless score q-3-0-3 q-3 matches ..1 run scoreboard players set q-3-0-3 q-3 1
