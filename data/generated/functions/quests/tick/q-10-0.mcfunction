...
scoreboard players operation q-10-0 q-10 += q-10-0-2 q-10
scoreboard players operation q-10-0 q-10 += q-10-0-3 q-10
scoreboard players operation q-10-0 q-10 *= 100 const
scoreboard players operation q-10-0 q-10 /= 400 const
