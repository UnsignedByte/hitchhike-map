...
scoreboard players operation q-6-0-1 q-6 *= 2 const
scoreboard players operation q-6-0-1 q-6 /= 100 const
execute unless score q-6-0-1 q-6 matches ..2 run scoreboard players set q-6-0-1 q-6 2
