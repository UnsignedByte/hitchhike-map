...
data modify storage generated:quest_book current[3] set value '{"text":"","color":"dark_gray","bold":false,"underlined":false,"hoverEvent":{"action":"show_text","contents":{"text":"Fill your stomach! Remember to keep a balanced diet (Fruit, vegetables, meat). How will Simon know if you finished this? A mystery."}},"extra":[{"text":"Full Stomach","italic":true}," (",{"score":{"name":"diet","objective":"quest-status"}},"%)"]}'
