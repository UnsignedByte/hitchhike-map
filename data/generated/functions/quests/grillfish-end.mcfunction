...
data modify storage generated:quest_book completed[11] set value '{"text":"","color":"gray","bold":false,"underlined":false,"strikethrough":true,"hoverEvent":{"action":"show_text","contents":{"text":"Grill some fish for Herb\'s late-night snack!"}},"extra":[{"text":"Fish-n-Chips","italic":true}," (100%)"]}'
