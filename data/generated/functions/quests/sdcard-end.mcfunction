...
execute as @e[tag=npc-simon,limit=1] if score @s dialogue-status matches 6 run scoreboard players set @s dialogue-status 8
execute as @e[tag=npc-simon,limit=1] unless score @s dialogue-status matches 5..6 run scoreboard players set @s dialogue-status 7
