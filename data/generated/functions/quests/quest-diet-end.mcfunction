...
data modify storage generated:quest_book completed[1] set value '{"text":"","color":"gray","bold":false,"underlined":false,"strikethrough":true,"hoverEvent":{"action":"show_text","contents":{"text":"Eat 500 pieces of meat (cooked, of course) and 500 vegetables"}},"extra":[{"text":"Balanced Diet","italic":true}," (200/200)"]}'
