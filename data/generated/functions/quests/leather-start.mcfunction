...
data modify storage generated:quest_book current[4] set value '{"text":"","color":"dark_green","bold":false,"underlined":false,"hoverEvent":{"action":"show_text","contents":{"text":"Make sure to dress warm!"}},"extra":[{"text":"Dressing Warm","italic":true}," (",{"score":{"name":"leather","objective":"quest-status"}},"%)"]}'
