...
execute if score q-2-0-0 q-2 = oq-2-0-0 q-2 run scoreboard players set - q-2 1
...
scoreboard players operation leather quest-status = q-2 q-2
execute if score leather quest-status matches 100 run function generated:quests/quest-leather-end
