...
function generated:quests/tick/q-2-0-1-3
scoreboard players set - q-2 0
execute if score q-2-0-1-0 q-2 = oq-2-0-1-0 q-2 if score q-2-0-1-1 q-2 = oq-2-0-1-1 q-2 if score q-2-0-1-2 q-2 = oq-2-0-1-2 q-2 if score q-2-0-1-3 q-2 = oq-2-0-1-3 q-2 run scoreboard players set - q-2 1
