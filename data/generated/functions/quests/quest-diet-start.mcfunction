...
data modify storage generated:quest_book current[1] set value '{"text":"","color":"dark_green","bold":false,"underlined":false,"hoverEvent":{"action":"show_text","contents":{"text":"Eat 5 pieces of meat (cooked, of course) and 5 vegetables"}},"extra":[{"text":"Balanced Diet","italic":true}," (",{"score":{"name":"diet","objective":"quest-status"}},"/10)"]}'
