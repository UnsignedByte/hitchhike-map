...
execute as @e[tag=maze-weapon-displaystand,nbt={Item:{tag:{weapon:"medicine"}}}] at @s positioned ~-1 ~-1 ~-1 run scoreboard players set @a[dx=2,dy=2,dz=2] maze-weapon-seld 4
...
execute as @a[scores={maze-weapon-seld=0..}] unless entity @s[scores={maze-weapon-seld=4}] run clear @s minecraft:dragon_breath{weapon:"medicine",isweapon:1b}
...
execute as @a[scores={maze-weapon-seld=0..}] if entity @s[scores={maze-weapon-seld=4}] unless entity @s[nbt={Inventory:[{tag:{weapon:"medicine"}}]}] run function generated:story/maze/weapons/medicine/give
