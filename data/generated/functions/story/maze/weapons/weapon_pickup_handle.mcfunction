...
execute as @a[scores={maze-weapon-seld=0..}] if entity @s[scores={maze-weapon-seld=2}] unless entity @s[nbt={Inventory:[{tag:{weapon:"frenchflag"}}]}] run function generated:story/maze/weapons/frenchflag/give
