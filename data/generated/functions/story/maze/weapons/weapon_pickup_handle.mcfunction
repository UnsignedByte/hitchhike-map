...
execute as @e[tag=maze-weapon-displaystand,nbt={Item:{tag:{weapon:"pointer"}}}] at @s positioned ~-0.8 ~-1 ~-0.8 run scoreboard players set @a[dx=1.6,dy=2,dz=1.6] maze-weapon-seld 0
execute as @e[tag=maze-weapon-displaystand,nbt={Item:{tag:{weapon:"commandblock"}}}] at @s positioned ~-0.8 ~-1 ~-0.8 run scoreboard players set @a[dx=1.6,dy=2,dz=1.6] maze-weapon-seld 1
execute as @e[tag=maze-weapon-displaystand,nbt={Item:{tag:{weapon:"firewall"}}}] at @s positioned ~-0.8 ~-1 ~-0.8 run scoreboard players set @a[dx=1.6,dy=2,dz=1.6] maze-weapon-seld 2
execute as @e[tag=maze-weapon-displaystand,nbt={Item:{tag:{weapon:"spoon"}}}] at @s positioned ~-0.8 ~-1 ~-0.8 run scoreboard players set @a[dx=1.6,dy=2,dz=1.6] maze-weapon-seld 3
execute as @e[tag=maze-weapon-displaystand,nbt={Item:{tag:{weapon:"frenchflag"}}}] at @s positioned ~-0.8 ~-1 ~-0.8 run scoreboard players set @a[dx=1.6,dy=2,dz=1.6] maze-weapon-seld 4
execute as @e[tag=maze-weapon-displaystand,nbt={Item:{tag:{weapon:"medicine"}}}] at @s positioned ~-0.8 ~-1 ~-0.8 run scoreboard players set @a[dx=1.6,dy=2,dz=1.6] maze-weapon-seld 5
