...
execute as @a[scores={maze-weapon-seld=0..}] if entity @s[scores={maze-weapon-seld=0}] run function generated:story/maze/weapons/spoon/give
...
execute as @a[scores={maze-weapon-seld=0..}] if entity @s[scores={maze-weapon-seld=1}] run function generated:story/maze/weapons/commandblock/give
execute as @a[scores={maze-weapon-seld=0..}] unless entity @s[scores={maze-weapon-seld=2}] run clear @s minecraft:white_banner{weapon:"frenchflag",isweapon:1b}
execute as @a[scores={maze-weapon-seld=0..}] if entity @s[scores={maze-weapon-seld=2}] run function generated:story/maze/weapons/frenchflag/give
