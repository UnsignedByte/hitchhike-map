...
execute as @e[tag=maze-weapon-displaystand,nbt={Item:{tag:{weapon:"pointer"}}}] at @s positioned ~-1 ~-1 ~-1 run scoreboard players set @a[dx=2,dy=2,dz=2] maze-weapon-seld 0
...
execute as @e[tag=maze-weapon-displaystand,nbt={Item:{tag:{weapon:"firewall"}}}] at @s positioned ~-1 ~-1 ~-1 run scoreboard players set @a[dx=2,dy=2,dz=2] maze-weapon-seld 2
execute as @e[tag=maze-weapon-displaystand,nbt={Item:{tag:{weapon:"spoon"}}}] at @s positioned ~-1 ~-1 ~-1 run scoreboard players set @a[dx=2,dy=2,dz=2] maze-weapon-seld 3
execute as @e[tag=maze-weapon-displaystand,nbt={Item:{tag:{weapon:"frenchflag"}}}] at @s positioned ~-1 ~-1 ~-1 run scoreboard players set @a[dx=2,dy=2,dz=2] maze-weapon-seld 4
execute as @e[tag=maze-weapon-displaystand,nbt={Item:{tag:{weapon:"medicine"}}}] at @s positioned ~-1 ~-1 ~-1 run scoreboard players set @a[dx=2,dy=2,dz=2] maze-weapon-seld 5
