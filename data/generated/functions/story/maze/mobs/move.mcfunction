...
execute as @e[tag=maze-mob,tag=maze-mob-johnny] at @s if predicate hitchhike:movechance if entity @p[distance=..16] run function generated:story/maze/mobs/move/johnny/main
