...
execute if score @s maze-path-parent matches 0 at @s positioned ~8 ~0 ~0 as @e[type=marker,tag=maze-node,tag=maze-node,distance=..0.01,sort=nearest,limit=1] run say @s
...
execute if score @s maze-path-parent matches 1 at @s positioned ~0 ~8 ~0 as @e[type=marker,tag=maze-node,tag=maze-node,distance=..0.01,sort=nearest,limit=1] run say @s
...
execute if score @s maze-path-parent matches 2 at @s positioned ~0 ~0 ~8 as @e[type=marker,tag=maze-node,tag=maze-node,distance=..0.01,sort=nearest,limit=1] run say @s
...
execute if score @s maze-path-parent matches 3 at @s positioned ~0 ~0 ~-8 as @e[type=marker,tag=maze-node,tag=maze-node,distance=..0.01,sort=nearest,limit=1] run say @s
...
execute if score @s maze-path-parent matches 4 at @s positioned ~0 ~-8 ~0 as @e[type=marker,tag=maze-node,tag=maze-node,distance=..0.01,sort=nearest,limit=1] run say @s
...
execute if score @s maze-path-parent matches 5 at @s positioned ~-8 ~0 ~0 as @e[type=marker,tag=maze-node,tag=maze-node,distance=..0.01,sort=nearest,limit=1] run say @s
