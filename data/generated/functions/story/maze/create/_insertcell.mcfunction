...
execute as @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-1] run tag @s add maze-connect--1
...
execute as @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-2] run tag @s add maze-connect--1
...
execute as @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-3] run tag @s add maze-connect--1
...
execute as @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-5] run tag @s add maze-connect--1
