...
execute as @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-0] run tag @s add maze-connect-5
execute if entity @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-1] positioned ~0 ~4 ~0 run fill ~-2 ~0 ~-2 ~2 ~0 ~2 air
execute if entity @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-1] run tag @s add maze-connect-1
execute as @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-1] run tag @s add maze-connect-4
execute if entity @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-2] positioned ~0 ~0 ~4 run fill ~-2 ~-2 ~0 ~2 ~2 ~0 air
...
execute if entity @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-3] positioned ~0 ~0 ~-4 run fill ~-2 ~-2 ~0 ~2 ~2 ~0 air
...
execute if entity @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-4] positioned ~0 ~-4 ~0 run fill ~-2 ~0 ~-2 ~2 ~0 ~2 air
execute if entity @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-4] run tag @s add maze-connect-4
execute as @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-4] run tag @s add maze-connect-1
...
execute as @e[type=marker,tag=maze-marker,tag=maze-connect,tag=maze-neighbor-5] run tag @s add maze-connect-0
