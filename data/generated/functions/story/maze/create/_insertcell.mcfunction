...
# Delete wall
execute if entity @e[type=marker,tag=maze-node,tag=maze-connect,tag=maze-neighbor-0] positioned ~4 ~0 ~0 run fill ~0 ~-2 ~-2 ~0 ~2 ~2 air
...
execute if entity @e[type=marker,tag=maze-node,tag=maze-connect,tag=maze-neighbor-1] positioned ~0 ~4 ~0 run fill ~-2 ~0 ~-2 ~2 ~0 ~2 air
...
execute if entity @e[type=marker,tag=maze-node,tag=maze-connect,tag=maze-neighbor-2] positioned ~0 ~0 ~4 run fill ~-2 ~-2 ~0 ~2 ~2 ~0 air
...
execute if entity @e[type=marker,tag=maze-node,tag=maze-connect,tag=maze-neighbor-3] positioned ~0 ~0 ~-4 run fill ~-2 ~-2 ~0 ~2 ~2 ~0 air
...
execute if entity @e[type=marker,tag=maze-node,tag=maze-connect,tag=maze-neighbor-4] positioned ~0 ~-4 ~0 run fill ~-2 ~0 ~-2 ~2 ~0 ~2 air
...
execute if entity @e[type=marker,tag=maze-node,tag=maze-connect,tag=maze-neighbor-5] positioned ~-4 ~0 ~0 run fill ~0 ~-2 ~-2 ~0 ~2 ~2 air
