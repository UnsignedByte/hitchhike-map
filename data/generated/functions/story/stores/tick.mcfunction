...
# Deal with triggers
execute as @a unless entity @s storetrigger matches 0 at @s if entity @s[x=881,z=-169,dx=36,dz=18] run function generated:story/stores/safeway/handletrigger
...
# Deal with triggers
execute as @a unless entity @s storetrigger matches 0 at @s if entity @s[x=973,z=-172,dx=19,dz=19] run function generated:story/stores/clothes/handletrigger
# reset status if no items to buy
...
# Deal with triggers
execute as @a unless entity @s storetrigger matches 0 at @s if entity @s[x=941,z=-161,dx=14,dz=20] run function generated:story/stores/subway/handletrigger
# reset status if no items to buy
...
# Deal with triggers
execute as @a unless entity @s storetrigger matches 0 at @s if entity @s[x=993,z=-173,dx=14,dz=20] run function generated:story/stores/boba/handletrigger
# reset status if no items to buy
