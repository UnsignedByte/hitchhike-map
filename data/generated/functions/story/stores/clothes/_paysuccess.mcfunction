...
data modify storage hitchhike:stores success.clothes set value '["Have fun with your new clothes! ",{"score":{"name":"1_B","objective":"stores"}},".",{"score":{"name":"1_b","objective":"stores"}}," Bov is your change."]'
# sell items.
