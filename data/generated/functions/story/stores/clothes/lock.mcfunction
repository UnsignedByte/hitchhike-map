...
execute unless score @s store_lockT matches 1.. run tellraw @s ["<",{"text":"Jean Skinne","color":"#2387d9","bold":true},"> You aren't leaving without paying. Don't make me tell you again."]
