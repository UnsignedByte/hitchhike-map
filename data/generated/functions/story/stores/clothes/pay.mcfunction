...
execute as @e[tag=paying,type=item,x=983,y=65,z=-168,dx=2,dy=0,dz=0] run data modify entity @s PickupDelay set value 20
# count payment and attempt to pay
scoreboard players set paymentcount stores 0
execute as @e[tag=paying,type=item,x=983,y=65,z=-168,dx=2,dy=0,dz=0] run function generated:story/stores/countpay
