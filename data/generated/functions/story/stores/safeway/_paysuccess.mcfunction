...
data modify storage hitchhike:stores success.safeway set value '["Thanks for shopping at Safeway! Your change is ",{"score":{"name":"0_B","objective":"stores"}},".",{"score":{"name":"0_b","objective":"stores"}}," Bck."]'
# sell items.
