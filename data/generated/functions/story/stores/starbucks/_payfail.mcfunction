...
execute if score count change matches 0 run data modify storage hitchhike:stores success.starbucks set value '["Alright, that\'ll be ",{"score":{"name":"5_B","objective":"stores"}},".",{"score":{"name":"5_b","objective":"stores"}}," Bov."]'
