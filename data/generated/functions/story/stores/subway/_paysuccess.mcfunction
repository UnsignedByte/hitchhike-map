...
data modify storage hitchhike:stores success.subway set value '["Have a great day. Here, have your change, ",{"score":{"name":"2_B","objective":"stores"}},".",{"score":{"name":"2_b","objective":"stores"}}," Bov."]'
# sell items.
