...
execute if score count change matches 1.. run data modify storage hitchhike:stores success.subway set value '["I still need ",{"score":{"name":"2_B","objective":"stores"}},".",{"score":{"name":"2_b","objective":"stores"}},"Bov more. Don\'t worry about the math though, I can calculate the change for you."]'
