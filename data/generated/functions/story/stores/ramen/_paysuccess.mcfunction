...
data modify storage hitchhike:stores success.ramen set value '[{"score":{"name":"4_B","objective":"stores"}},".",{"score":{"name":"4_b","objective":"stores"}}," Bck is your change. ありがとございました！"]'
# sell items.
