execute positioned 914.5 49 -72.5 if entity @e[type=item,distance=..1,nbt={Item:{id: "minecraft:sunflower", tag: {display: {Name: '{"text":"1 BTC","color":"gold"}', Lore: ['{"text":"Valued at 1.00 BOV"}']}}}}] run playsound minecraft:entity.experience_orb.pickup neutral @a 914 56 -73 1
