...
execute as @a[tag=parkour-offtrail] at @s if block ~-0.3 ~0 ~-0.3 air if block ~-0.3 ~0 ~0.3 air if block ~0.3 ~0 ~-0.3 air if block ~0.3 ~0 ~0.3 air if block ~-0.3 ~1 ~-0.3 air if block ~-0.3 ~1 ~0.3 air if block ~0.3 ~1 ~-0.3 air if block ~0.3 ~1 ~0.3 air run tag remove @s parkour-offtrail
