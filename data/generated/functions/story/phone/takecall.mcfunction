...
give @a[tag=song-ios] minecraft:black_candle{Enchantments: [{}], display: {Lore: ['{"text":"Only 13 nanometers thick.","color":"dark_gray"}'], Name: '{"text":"iPhone XXGS Pro Max Plus+ Ultra","color":"gray"}'}, phone: 1b, iosphone: 1b} 1
give @a[tag=song-android] minecraft:black_candle{Enchantments: [{}], display: {Lore: ['{"text":"Runs Android 5.0.2 \\"Lollipop\\".","color":"dark_gray"}'], Name: '{"text":"Motorola Moto G 2","color":"gray"}'}, phone: 1b, androidphone: 1b} 1
