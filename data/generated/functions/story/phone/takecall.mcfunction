...
execute if entity @s[nbt={HandItems:[{tag:{iosphone:1b}}]}] run give @a[tag=phone-detect-selected] minecraft:black_candle{Enchantments: [{id:"minecraft:unbreaking",lvl:1s}], display: {Lore: ['{"text":"Only 13 nanometers thick.","color":"gray"}','{"text":"Use it by right clicking","color":"blue"}','{"text":"while standing still.","color":"blue"}'], Name: '{"text":"iPhone XXGS Pro Max Plus+ Ultra","color":"gray"}'}, HideFlags: 127, phone: 1b, iosphone: 1b} 1
execute if entity @s[nbt={HandItems:[{tag:{androidphone:1b}}]}] run give @a[tag=phone-detect-selected] minecraft:black_candle{Enchantments: [{id:"minecraft:unbreaking",lvl:1s}], display: {Lore: ['{"text":"Runs Android 5.0.2 \\"Lollipop\\".","color":"gray"}','{"text":"Use it by right clicking","color":"blue"}','{"text":"while standing still.","color":"blue"}'], Name: '{"text":"Motorola Moto G 2","color":"gray"}'}, HideFlags: 127, phone: 1b, androidphone: 1b} 1
