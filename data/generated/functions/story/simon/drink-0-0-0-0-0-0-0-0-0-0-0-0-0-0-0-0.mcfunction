...
execute at @e[tag=npc-simon,limit=1] run summon item ~ ~1 ~ {Motion: [-0.5,0.3,0.125], PickupDelay: 20, Item: {id: "minecraft:glass_bottle", Count: 1b, tag: {Enchantments: [{id:"minecraft:unbreaking",lvl:1s}]}}}
