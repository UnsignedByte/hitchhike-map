...
execute store success score dialogue-begun dialogue-status if entity @a[tag=victim-of-dialogue-by-__mysteryshrooms, tag=!spoken-to, limit=1] as @e[tag=npc-__mysteryshrooms, limit=1] if score @s dialogue-status matches 0 run schedule function generated:npc/__mysteryshrooms/0-0 1t
