...
execute unless score start story-hurm matches 1 positioned 1078 125 359 unless block ~ ~ ~ dark_oak_door[facing=south,half=lower,hinge=right,open=false,powered=false] run tag @p add hurm-selected
