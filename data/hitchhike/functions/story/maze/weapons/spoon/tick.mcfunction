...
execute if score @s maze-weapon-age matches 20 run tp @s ~ ~ ~ ~ 90
execute if score @s maze-weapon-age matches 30 run playsound minecraft:entity.wither.shoot player @a ~ ~ ~ 0.2 0
execute at @s if score @s maze-weapon-age matches 30.. unless block ~ ~ ~-0.75 air run scoreboard players set @s maze-weapon-age 60
