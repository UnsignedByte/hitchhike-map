...
execute at @s if score @s maze-weapon-age matches ..19 if entity @e[tag=maze-mob,dx=0,dy=0,dz=0,type=!player] run scoreboard players set @s maze-weapon-age 20
