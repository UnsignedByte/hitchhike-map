execute if predicate hitchhike:spreadfreeze at @s as @e[tag=maze-mob,type=!player,tag=!maze-mob-frozen,distance=..5,sort=random,limit=5] run function hitchhike:story/maze/weapons/commandblock/onhit
