...
execute at @e[tag=maze-shulker-hit] run summon creeper ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,ExplosionRadius:2b,Fuse:0,CustomName:'{"text":"Command Block","color":"aqua","bold":true,"italic":true}'}
