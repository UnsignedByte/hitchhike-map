...
summon potion 0 0 0 {Tags:["maze-weapon-potion-init"],Item:{id:"minecraft:lingering_potion",Count:1b,tag:{Potion:"minecraft:water",CustomPotionColor:14048946,CustomPotionEffects:[{Id:2b,Amplifier:3b,Duration:200},{Id:4b,Amplifier:1b,Duration:300},{Id:9b,Amplifier:0b,Duration:300},{Id:18b,Amplifier:2b,Duration:200},{Id:20b,Amplifier:9b,Duration:200},{Id:24b,Amplifier:0b,Duration:300}],Enchantments:[{}]}}}
