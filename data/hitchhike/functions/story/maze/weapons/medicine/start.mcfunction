...
ssummon potion 0 0 0 {Tags:["maze-weapon-potion-init"],Item:{id:"minecraft:splash_potion",Count:1b,tag:{CustomPotionColor:8866613,CustomPotionEffects:[{Id:2b,Amplifier:3b,Duration:200},{Id:4b,Amplifier:1b,Duration:300},{Id:9b,Amplifier:0b,Duration:15},{Id:15b,Amplifier:0b,Duration:15},{Id:18b,Amplifier:2b,Duration:10},{Id:20b,Amplifier:9b,Duration:200},{Id:24b,Amplifier:0b,Duration:15},{Id:25b,Amplifier:1b,Duration:5}],Enchantments:[{}]}}}
