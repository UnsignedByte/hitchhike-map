...
execute as @e[tag=maze-mob,dx=0,dy=0,dz=0] store result entity @s Motion[0] double 0.003 run scoreboard players get #tmpx2 maze-weapon-age
execute as @e[tag=maze-mob,dx=0,dy=0,dz=0] store result entity @s Motion[1] double 0.003 run scoreboard players get #tmpy2 maze-weapon-age
execute as @e[tag=maze-mob,dx=0,dy=0,dz=0] store result entity @s Motion[2] double 0.003 run scoreboard players get #tmpz2 maze-weapon-age
execute store result score #tmpx2 maze-weapon-age run data get entity @s Pos[0] 1000
execute as @e[tag=maze-mob,dx=0,dy=0,dz=0] store result entity @s FallDistance float 0.001 run scoreboard players get @s maze-weapon-age
