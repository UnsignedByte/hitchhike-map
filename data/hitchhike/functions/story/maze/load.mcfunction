...
scoreboard objectives add maze-pathGcost dummy
scoreboard objectives add maze-pathHcost dummy
scoreboard objectives add maze-pathTcost dummy
scoreboard objectives add maze-xpos dummy
scoreboard objectives add maze-ypos dummy
...
scoreboard objectives add maze-weapon-seld dummy
