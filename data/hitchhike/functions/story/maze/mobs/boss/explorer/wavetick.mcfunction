...
execute if score #tmp maze-weapon-age matches 0 if predicate hitchhike:onethird run playsound minecraft:block.bubble_column.upwards_inside hostile @a ~ ~ ~ 0.8 0.3
