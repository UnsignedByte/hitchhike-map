...
execute at @e[tag=path-start] run summon slime ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Glowing:1b,PersistenceRequired:1b,NoAI:1b,Tags:["maze-path-start-marker","invisible"],ActiveEffects:[{Id:14b,Amplifier:0b,Duration:2147483647}]}
