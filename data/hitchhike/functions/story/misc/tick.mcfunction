...
execute if block 973 70 2 minecraft:dark_oak_door[facing=west,half=lower,hinge=right,open=false,powered=false] run data merge entity @e[tag=!maisebovat-awoken,tag=npc-maisebovat,limit=1] {SleepingX:970,SleepingY:70,SleepingZ:4}
