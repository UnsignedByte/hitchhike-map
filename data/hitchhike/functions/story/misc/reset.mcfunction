...
execute unless block 973 70 2 minecraft:dark_oak_door[facing=west,half=lower,hinge=right,open=false,powered=false] run tp @e[tag=npc-maisebovat,limit=1,nbt=!{SleepingX:970,SleepingY:70,SleepingZ:4}] 970 70 2 -90 0