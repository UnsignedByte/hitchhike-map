...
title @a[x=819,y=114,z=411,dx=0,dy=1,dz=0,nbt=!{Inventory:[{Slot:100b,tag:{snowshoes:1b}}]}] actionbar {"text":"Please put on snow boots before proceeding toward the summit.","color":"yellow"}
