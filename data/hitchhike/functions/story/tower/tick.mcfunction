...
execute as @a[x=984,y=245,z=561,dx=4,dy=5,dz=4,scores={tower-openbox=1..},nbt={SelectedItem:{tag:{boxkey:1b}}},limit=1] run function hitchhike:story/tower/puzzles/start
