...
execute unless entity @a[tag=maze-mob] unless entity @e[tag=path-start] run tp @a[tag=maze-warping] @e[tag=maze-start,limit=1]
execute unless entity @a[tag=maze-mob] run tp @a[tag=maze-warping] @e[tag=path-start,limit=1]
