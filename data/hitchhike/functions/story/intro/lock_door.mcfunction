...
execute if score basement_lock story-intro matches 0 run schedule function hitchhike:story/intro/unlock_door
execute if score basement_lock story-intro matches 1 run schedule function hitchhike:story/intro/lock_door