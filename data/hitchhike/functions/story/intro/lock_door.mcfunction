...
execute if block 1012 59 64 minecraft:birch_door[facing=west,half=lower,hinge=right,open=true,powered=false] run playsound minecraft:block.wooden_door.close block @a 1012.5 60 64.5 1 1
