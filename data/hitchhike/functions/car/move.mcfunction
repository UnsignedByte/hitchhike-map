...
execute rotated ~ 0 positioned ^ ^ ^1000 run function hitchhike:car/_storeoffset

execute store result score -X car run data get entity @s Pos[0] 1000
execute store result score -Y car run data get entity @s Pos[1] 1000
...
execute store result entity @s Motion[1] double 0.000001 run scoreboard players get -vY car
